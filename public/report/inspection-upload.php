                ...
                <div class="container-fluid">
                    ...
                    <span class="fileinput-new">Select File</span>
                                ...
                                <div class="card-footer ">
                                    <button type="submit" name="submit_upload_report_hard_coded" class="btn btn-fill btn-rose">Upload</button>
                                ...
                                <?php
                                    if(isset($_POST['submit_upload_report_hard_coded'])){
                                        if($_SESSION['result_upload']=='ok'){                                  
                                            echo"<script>alert('Report successfully uploaded.')</script>";
                                            echo("<meta http-equiv='refresh' content='1'>");   
                                        }else{
                                            echo"<script>alert('Error. Please check if all the fields is correct.')</script>";
                                        }                                      
                                    }
                                ?>
                            </div>
