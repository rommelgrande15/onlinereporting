                ...
                <div class="container-fluid">
                    ...
                    <span class="fileinput-new">Select File</span>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <?php $client_email=selectLogInDetails("email",$_GET['comp_id']); ?>
                                ...
                                <div class="card-footer ">
                                    <button type="submit" name="submit_upload_report" class="btn btn-fill btn-rose">Upload</button>
                                   <!--  <button type="button" id="submit_upload_report" onclick="getRecipient()" class="btn btn-fill btn-rose">Upload</button> -->
                                </div>
                                </form>
                                <?php
                                    if(isset($_POST['submit_upload_report']) && $_SESSION['result_upload']=='ok'){
