...
if(empty($_SESSION['email'])){
  ...
  //echo $_GET['comp_id'];
  //selectReportReviewDetailsWithRef("factory_email",$_GET['comp_id'],$_GET['ref_num']); 
      ...
      <span class="sr-only">Toggle navigation</span>
            ...
            <div class="content">
                <div class="container-fluid">
                    ...
                    <span class="fileinput-new">Select File</span>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <?php 
                                                ...
                                                $fac_email=selectReportReviewDetailsWithRef("factory_email",$_GET['comp_id'],$_GET['ref_num']); 
                                                $ins_date=selectReportReviewDetailsWithRef("inspection_date",$_GET['comp_id'],$_GET['ref_num']);
                                                $ship_date=selectReportReviewDetailsWithRef("shipment_date",$_GET['comp_id'],$_GET['ref_num']); 
                                                $fac_name=selectReportReviewDetailsWithRef("factory_name",$_GET['comp_id'],$_GET['ref_num']);
                                                $get_ref_num=$_GET['ref_num'];
                                                $get_comp_id=$_GET['comp_id'];
                                            ?>
                                            <input type="hidden" name="ref_num" value="<?= $get_ref_num?>">
                                            <input type="hidden" name="comp_id" value="<?= $get_comp_id; ?>">
                                            <input type="hidden" name="fac_email" value="<?= $fac_email; ?>">
                                            <input type="hidden" name="ins_date" value="<?= $ins_date; ?>">
                                            <input type="hidden" name="ship_date" value="<?= $ship_date; ?>">
                                            <input type="hidden" name="fac_name" value="<?= $fac_name; ?>">
                                            <?php $client_email=selectLogInDetails("email",$get_comp_id); ?>
                                            <label class="title">Client Email :</label> <?= $client_email; ?> <span style="color:gray;">(automatically added in recipient)</span><br>
                                ...
                                <div class="card-footer ">
                                    <button type="submit" name="submit_upload_report_hard_coded_edit" class="btn btn-fill btn-rose">Upload</button>
                                   <!--  <button type="button" id="submit_upload_report" onclick="getRecipient()" class="btn btn-fill btn-rose">Upload</button> -->
                                </div>
                                </form>
                                <?php
                                    if(isset($_POST['submit_upload_report_hard_coded_edit']) && $_SESSION['result_upload']=='ok'){
                    ...
                    <br>
                    <?php
                        $reports=selectAllReportsNew2($_GET['comp_id'],$_GET['ref_num']);
                            ...
                            <div class="card card-product">
                                ...
                                <div class="card-body">
                                    <div class="card-actions text-center">
                                        ...
                                        <button type="button" class="btn btn-success btn-link" onclick="window.location.href='reports/<?= $result['file_name']; ?>'"  title="View">
