$(document).ready(function() {
    ...
    $('body').on('click', '#add_insp_other_cost', function() {
        $('.ins_other_cost_container').append('<div class="ins_cost_div"><div class="col-md-6">' +
            ...
            '<label>Cost</label>' +
            '<div class="input-group">' +
            '<input type="number" class="form-control ins_other_cost_value psi_required" name="ins_other_cost_value" onkeyup="Inspector_Total_Cost_New()">' +
            '<div class="input-group-btn">' +
    ...
    $('body').on('click', '#add_cli_other_cost', function() {
        $('.cli_other_cost_container').append('<div class="cli_cost_div"><div class="col-md-6">' +
            ...
            '<label>Cost</label>' +
            '<div class="input-group">' +
            '<input type="number" class="form-control cli_other_cost_value cli_required" name="cli_other_cost_value" onkeyup="Inspector_Total_Cost_New()">' +
            '<div class="input-group-btn">' +
