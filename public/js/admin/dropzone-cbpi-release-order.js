    ...
    var myDZ = new Dropzone("div.file_upload_psi", {
        ...
        init: function() {
            $("#btn-psi-submit").click(function(e) {
                ...
                change_draft_dropzone_url_cbpi = releaseorder;
            ...
            $("#btn-cbpi-hold").click(function(e) {
                e.preventDefault();
                e.stopPropagation();
                button_click = "submit";
                inspection_status = "Hold";
                change_draft_dropzone_url_cbpi = holdorder;
                var empty = $('.psi_required').filter(function() { return $(this).val() == ""; });
                var pt = $("input[name='project_type']:checked").val();
                var psi_req = $('.psi_required');
                var count_null = 0;
            ...
            this.on("sendingmultiple", function(data, xhr, formData) {
                ...
                formData.append("template_word", $('#template_word').val()); //05-05-2021
