    ...
    var myDropzone = new Dropzone("div.file_upload", {
        ...
        init: function() {
            ...
            this.on("sendingmultiple", function(data, xhr, formData) {
                ...
                formData.append("fm_username_cbpi", $('#fm_username_cbpi').val());
                formData.append("fm_password_cbpi", $('#fm_password_cbpi').val());
                formData.append("fm_inspector_cbpi", $('#fm_inspector_cbpi').val());
                ...
                formData.append("complex_report", $('#complex_report_cbpi').val());
                ...
                formData.append("loading_template_word", $('#loading_template_word').val()); //05-05-2021
                ...
                //     if (loading_template_word != ""){ type_of_project = "app_project";}
...
function saveCbpiDraft() {
    ...
    var loading_inspection_date_to = $("#loading_inspection_date_to").val();
    var loading_client = $('#loading_client').val();
    var loading_inspector = $('#loading_inspector').val();
    var fm_username_cbpi = $('#fm_username_cbpi').val();
    var fm_password_cbpi = $('#fm_password_cbpi').val();
    var fm_inspector_cbpi = $('#fm_inspector_cbpi').val();
    ...
    var complex_report = $('#complex_report_cbpi').val();
    ...
    $.ajax({
        ...
        data: {
            ...
            loading_inspection_date_to: loading_inspection_date_to,
            loading_client: loading_client,
            loading_inspector: loading_inspector,
            fm_username_cbpi: fm_username_cbpi,
            fm_password_cbpi: fm_password_cbpi,
            fm_inspector_cbpi: fm_inspector_cbpi,
            ...
            loading_template_word: loading_template_word, //05-05-2021
