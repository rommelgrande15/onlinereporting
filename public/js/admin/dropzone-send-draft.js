$(document).ready(function() {
    ...
    var myDropzone = new Dropzone("div.file_upload", {
        ...
        init: function() {
            ...
            $("#CBPI_submit_no_email").click(function(e) {
                e.preventDefault();
                e.stopPropagation();
                change_draft_dropzone_url_cbpi = saveCBPI;
                button_click_cbpi = "submit";
            ...
            this.on("sendingmultiple", function(data, xhr, formData) {
                ...
                formData.append("fm_username_cbpi", $('#fm_username_cbpi_edit').val());
                formData.append("fm_password_cbpi", $('#fm_password_cbpi_edit').val());
                formData.append("fm_inspector_cbpi", $('#fm_inspector_cbpi_edit').val());
            ...
            this.on("successmultiple", function(files, response) {
                ...
                if (button_click_cbpi == 'draft') {
                    swal({
                        title: "Success!",
                        text: "Inspection project has been updated1",
                        type: "success",
                    }, function() {
...
function updateCbpiDraft() {
    ...
    var fm_inspector_cbpi = $('#fm_inspector_cbpi_edit').val();
    var old_inspector = $('#old_inspector_cbpi').val();
    ...
    $.ajax({
        ...
        data: {
            ...
            loading_template_word: loading_template_word,
...
function publishCbpiDraft(send_email) {
    var edit_inspection_id_cbpi = $("#edit_inspection_id_cbpi").val();
    var loading_service = $("#loading_service_inspection").val();
    ...
    var loading_inspector = $('#loading_inspector').val();
    var fm_username_cbpi = $('#fm_username_cbpi_edit').val();
    var fm_password_cbpi = $('#fm_password_cbpi_edit').val();
    var fm_inspector_cbpi = $('#fm_inspector_cbpi_edit').val();
    var old_inspector = $('#old_inspector_cbpi').val();
