...
function getInspectionsData() {
    var table = $("#inspections_table tbody");
    $.ajax({
        url: '/panel-get-data-dev',
        type: 'GET',
        success: function(response) {
            console.log(response);
            table.empty();
            $.each(response.inspection, function(index, value) {
                table.append("<tr><td>" + value.client_id + "</td>" +
                    "<td>" + value.service + "</td>" +
                    "<td>" + value.reference_number + "</td>" +
                    "<td>" + value.p_name + "</td>" +
                    "<td>" + value.po + "</td>" +
                    "<td>" + value.address + "</td>" +
                    "<td>" + value.inspector_name + "</td>" +
                    "<td>" + value.created_by + "</td>" +
                    "<td>" + value.inspection_date + "</td>" +
                    "<td>" + value.inspection_status + "</td>" +
                    "<td>" + value.inspection_status + "</td></tr>");
            });
            $("#inspections_table").DataTable();
