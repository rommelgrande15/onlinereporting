...
$target_dir = "upload/sub_upload/$session_user_id" . "_" . "PP_" . "$date_time/";
...
$Fname=$_POST['name'];
$stmt5=$conn->prepare("DELETE FROM `product_photos_sub` where `file_name` = '$Fname' and status = '0' and photo_category ='PP'");
	if($stmt5->execute()){
		$msg = "Successfully";
	}else{
		$msg = "error";
