$(document).ready(function() {
    ...
    //product category in new order modal
    ...
    //product category in new order not modal
    ...
    $('.order_product_sub_category').on('change', function() {
        var dis = this;
        var sub_cat_val = $(dis).val();
        if (sub_cat_val == 'Others' || sub_cat_val == 'others') {
            $(this).closest('.div_sub_category').find('.modalSubCategory').modal('show');
    ...
    //this is the old function of button add more product
    $('#btn_product').click(function() {
        ...
        if (add_count_null >= 1) {
            ...
            content_clone.append('<div class="row"><div class="col-md-12">' +
                '<div class="form-group">' +
                '<br/><button type="button" class="btn btn-danger btn-rm pull-right" style="margin-right:2rem"><i class="fa fa-times"></i> Remove Product</button>' +
                '</div>' +
                '</div>' +
                '</div>');
    ...
    $('body').on('click', '.btn-add-more-product', function() {
        var add = $('.input-new-prod');
        var add_count_null = 0;
        for (var i = 0; i < add.length; i++) {
            var data = $(add[i]).val();
        ...
        if (add_count_null >= 1) {
            ...
            content_clone.append('<div class="row"><div class="col-md-12">' +
                ...
                '</div>');
            //content_clone.appendTo('.product-clone');
            $(this).closest('.product-with-report').find('.product-clone').append(content_clone);
        }
    });
    $('body').on('click', '.btn-rm-product-report', function() {
        $(this).closest('.product-with-report').remove();
        var rp_counter = 0;
        var get_ref_num = $('#system_reference_number').val();
    ...
    $('#btn_product_report_num').click(function() {
        ...
        if (get_ref_num == null || get_ref_num == '') {
            swal({
                title: "Warning!",
                text: "Please select inspection date first!",
                type: "warning",
            });
        } else {
            ...
            $('#product-rows').append(
                ...
                '    		<button type="button" class="btn btn-info pull-right btn-add-more-product"  style="margin-top:2rem; margin-left:1rem">' +
    ...
    $('body').on('click', '.choose-prod', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#' + btn_id).closest('.clone-inputs').find('.order_product_category').val(response.product.product_category);
                ...
                $('#' + btn_id).closest('.clone-inputs').find('.order_product_sub_category').empty();
                $('#' + btn_id).closest('.clone-inputs').find('.order_product_sub_category').append('<option value="">Select Sub-product Category</option>');
                var cat_val = $('#' + btn_id).closest('.clone-inputs').find('.order_product_category').val();
                var dis_btn = $('#' + btn_id);
                getSubCategory(cat_val, dis_btn);
                setTimeout(function() {
                    $('#' + btn_id).closest('.clone-inputs').find('.order_product_sub_category').val(response.product.product_sub_category);
                }, 1000);
    ...
    $('body').on('click', '.btn-qty-modal', function() {
        var pamj = $(this).closest('.qty-modal').find('.preset_aql_major').val();
        var pamn = $(this).closest('.qty-modal').find('.preset_aql_minor').val();
        $(this).closest('.qty-modal').find('.aql_major').val(pamj);
        $(this).closest('.qty-modal').find('.aql_minor').val(pamn);
    ...
    $('body').on('click', '.confirm_aql', function() {
        ...
        dis.closest('.clone-inputs').find('.qty').removeAttr("style");
    ...
    $('.client_select').on('change', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('.contact_persons').append($('<option value="" selected disabled>Select Contact</option>'));
    ...
    $('body').on('change', '.factory', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                dis.closest('.factory-select').find('.factory_contact_person').append($('<option value="">Select Contact Person</option>'));
                var count = response.contacts.length;
                for (var i = 0; i <= count - 1; i++) {
    ...
    $('body').on('change', '.supplier', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                dis.closest('.factory-select').find('.factory_contact_person option').remove();
                dis.closest('.factory-select').find('.factory_contact_person').append($('<option value="">Select Factory Contact Person</option>'));

                dis.closest('.factory-select').find('.supplier_address').val(response.supplier.supplier_address);
                dis.closest('.factory-select').find('.supplier_code').val(response.supplier.supplier_number);
                dis.closest('.factory-select').find('.supplier_contact_person option').remove();
                dis.closest('.factory-select').find('.supplier_contact_person').append($('<option value="">Select Supplier Contact Person</option>'));
                ...
                dis.closest('.factory-select').find('.factory').append($('<option value="" selected>Select Factory</option>'));
    ...
    $('body').on('change', '#loading-supplier', function() {
        var dis = $(this);
        var supplier_text = $('#loading-supplier option:selected').text();
        //$('#new_factory_id').val(dis.val());
        $.ajax({
            url: '/getfactorysupplier/' + dis.val(),
            type: 'GET',
            success: function(response) {
                ...
                dis.closest('.factory-select').find('.supplier_address').val(response.supplier.supplier_address);
                dis.closest('.factory-select').find('.supplier_contact_person option').remove();
                dis.closest('.factory-select').find('.supplier_contact_person').append($('<option value="" selected>Select Supplier Contact Person</option>'));
                ...
                dis.closest('.factory-select').find('.factory option').remove();
                dis.closest('.factory-select').find('.factory').append($('<option value="">Select Factory</option>'));
                $.each(response.factories, function(i, element) {
                    dis.closest('.factory-select').find('.factory').append($("<option></option>").attr("value", element.id).text(element.factory_name));
                });
                if (response.factories.length == 1) {
                    ...
                    $.each(response.factories, function(i, element) {
                        ...
                        if (element.factory_name == supplier_text) {
                            console.log('factory same: yes');
                            $('#cli_fac_toggle_div').hide();
                            dis.closest('.factory-select').find('.factory').val(element.id);
                            dis.closest('.factory-select').find('.factory_contact_person').val();

                        } else {
                            console.log('factory same: no');
                            $('#cli_fac_toggle_div').show();
                        }
                    });
                } else {
                    console.log('else factory count:' + response.factories.length);
        ...
        if (count.length == 1 && $(".clone_fcp").is(":hidden")) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('.fcp_sel').append($('<option value="" selected disabled>Select Contact Person</option>'));
                    var count = response.contacts.length;
                    for (var i = 0; i <= count - 1; i++) {
        ...
        if (count.length == 1 && $(".clone_fcp_cbpi").is(":hidden")) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('.fcp_sel_cbpi').append($('<option value="" selected>Select Contact Person</option>'));
                    var count = response.contacts.length;
                    for (var i = 0; i <= count - 1; i++) {
    ...
    $('#loading_factory').on('change', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#loading_factory_contact_person').append($('<option value="">Select Contact Person</option>'));
                var count = response.contacts.length;
                for (var i = 0; i <= count - 1; i++) {
    ...
    $('body').on('change', '.product_name', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                dis.closest('.clone-inputs').find('.order_product_category').val(response.product.product_category);
                // dis.closest('.clone-inputs').find('.product_sub_category').val(response.product.product_sub_category);
                ...
                dis.closest('.clone-inputs').find('.addtnl_pinfo').val(response.product.additional_product_info);

                dis.closest('.clone-inputs').find('.order_product_sub_category').empty();
                dis.closest('.clone-inputs').find('.order_product_sub_category').append('<option value="">Select Sub-product Category</option>');
                var cat_val = response.product.product_category;
                getSubCategory(cat_val, dis);
                setTimeout(function() {
                    dis.closest('.clone-inputs').find('.order_product_sub_category').val(response.product.product_sub_category);
                }, 1000);
    ...
    $('body').on('click', '#add_more_client_c_p', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('.am_cp_parent').find('.added_contact_persons').append($('<option value="" selected disabled>Select Contact</option>'));
                var count = response.contacts.length;
                for (var i = 0; i <= count - 1; i++) {
    ...
    $('body').on('click', '.l-btn-cli-factory', function() {
        var sup_val = $('#loading-supplier').val()
        if (sup_val == '') {
            swal({
                title: "Warning!",
                text: "Please select supplier first.",
    ...
    $('body').on('click', '#btn-save-new-scat', function() {
        ...
        if (count_null == 0) {
            ...
            var category = $('#order_product_category').val();
            ...
            $.ajax({
                ...
                success: function(response) {
                    $('.send-loading ').hide();
                    console.log(response);
                    $('.order_product_sub_category').append('<option value="' + new_sub_cat_other + '">' + new_sub_cat_other + '</option>');
                    swal({
                        title: "Success!",
                        text: "Category successfully added.",
                        type: "success",
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    swal({
                        ...
                        $('.create_new_scat2').each(function() {
                            $(this).val('');
                        });
    ...
    $('body').on('click', '.btn-add-more-product-new', function() {
        var add = $('.input-new-prod');
        var add_count_null = 0;
        for (var i = 0; i < add.length; i++) {
            var data = $(add[i]).val();
        ...
        if (add_count_null >= 1) {
            ...
            var new_id = 'pclick-' + clone_count;
            var content_clone = $('.clone-inputs:first').clone();
            content_clone.find(".product-click-new").attr('id', new_id);
            content_clone.find(".col-view-att").hide();
            //product name
    ...
    var pr_report_counter = 0;
    $('#btn_product_report_num_new').click(function() {
        var pr_clone = $('.clone-inputs');
        var clone_count = pr_clone.length;
        console.log('clone_count: ' + clone_count);
        var new_id = 'pclick-' + clone_count;
        ...
        if (get_ref_num == null || get_ref_num == '') {
            ...
            $('#product-rows').append(
                ...
                '    <div class="row">' +
                '    	<div class="col-md-12 pull-right">' +
                '    		<button type="button" class="btn btn-info pull-right btn-add-more-product-new"  style="margin-top:2rem; margin-left:1rem">' +
                '    			<i class="fa fa-cube"></i> Add More Products' +
                '    		</button>' +
                '    		<button type="button" class="btn btn-danger pull-right btn-rm-product-report"  style="margin-top:2rem;">' +
                '    			<i class="fa fa-trash"></i> Remove all product with report' +
