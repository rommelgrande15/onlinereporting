var current_url = '/project-supplier/';
$(document).ready(function() {

    if (window.location.href.indexOf("tic-sera") > -1) {
        current_url = '/project-supplier-tic-sera/';
    }
    ...
    var myDZ = new Dropzone("div.file_upload_psi", {
        ...
        init: function() {
                ...
                this.on("sendingmultiple", function(data, xhr, formData) {
                    ...
                    formData.append("supplier-id", $('#supplier-id').val());
                    ...
                    $('.product_name_new').each(function(i, obj) {
                        var val = $(this).val();
                    ...
                    $('.addtnl_pinfo').each(function(i, obj) {
                        var val = $(this).val();
                        formData.append('addtnl_pinfo[]', val);
                    });
...
function saveNoAttachment() {
    ...
    $.ajax({
        url: '/supplier-client-saveinspection',
        type: 'POST',
        data: formData,
        contentType: false,
        processData: false,
