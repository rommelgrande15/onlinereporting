$(document).ready(function() {
    ...
    //VIEWING OF SUPPLIER FACTORY AND CONTACTS
    .on('click', '.btn-view-supplier-factory', function() {
            $('#btn-add-contact-person').attr("data-id", $(this).data('id'));
            var dis = this;
            $(dis).find('i').removeClass('fa fa-eye');
            $(dis).find('i').addClass('fa fa-refresh');
            $(dis).find('i').addClass('fa-loader');
            $.ajax({
                url: '/viewsupplier-factory/' + $(this).data('id'),
                type: 'GET',
                success: function(response) {
                    ...
                    $('#view_fac_addr2').text(response.factory_state);
                    $('#view_fac_addr3').text(response.factory_country_name);
                    ...
                    $('#modalviewSupplierFactory').modal();
        ...
        //EDITING SUPPLIER FACTORY AND CONTACTS
        .on('click', '.btn-edit-supplierfactory', function() {
            var dis = this;
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#updateSupplierFactory').modal('show');
    ...
    //ADD NEW FACTORY CONTACT PERSON
    .on('click', '.btn-add-contact-person', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#updateSupplierFactory').modal('toggle');
    ...
    //DELETING FACTORY CONTACT
    .on('click', '.btn-delete-factorycontact', function() {
        $.ajax({
            url: '/viewsupplier-factory/' + $(this).data('id'),
            type: 'GET',
            success: function(response) {
    ...
    //DELETE SUPPLIER FACTORY DETAILS
    .on('click', '#btn-delete-supplierfactory', function() {
        var dis = this;
        var id = $(dis).data('delete_id');


        $.ajax({
            url: '/delete-supplier-factory',
            type: 'POST',
            data: {
                _token: token,
                id: id
            ...
            success: function(response) {
                ...
                $('#delete_supplierfactory_id').val(response.factory[0].id);
                $('#delete_supplierfactory_name').html(response.factory[0].factory_name);
                $('#modalDeleteSupplierFactory').modal('show');
    ...
    .on('click', '.btn-view', function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                $('#view_fac_name').text(response.factory_name);
                $('#view_fac_number').text(response.factory_number);
                $('#view_fac_addr').text(response.factory_address);

                $('#view_fac_addr1').text(response.factory_city);
                $('#view_fac_addr2').text(response.factory_address);
                $('#view_fac_addr3').text(response.factory_city_local);
                $('#view_fac_addr4').text(response.factory_country_name);
