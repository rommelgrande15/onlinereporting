        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="number" class="form-control new_aql_qty" name="new_aql_qty" id="new_aql_qty" min="1" oninput="this.value = Math.abs(this.value)" required>
          ...
          <div class="col-md-6">
            ...
            <select class="form-control new_aql_qty_unit" id="new_aql_qty_unit" name="new_aql_qty_unit" required>
          ...
          <div class="col-md-12">
              <table class="table-bordered table-condensed" width="100%">
                ...
                <tr>
                  <th>Major</th>
                  <td>
                  <select type="text" name="new_aql_major" id="new_aql_major" class="form-control aql_select new_aql_major"required ></select>
                  <div id="aqlRequired4" style="display:none" ><p style="color:red;">This field is required! </p></div>
                  </td>
                  <td><input type="text " name="new_max_major" id="new_max_major" class="form-control new_max_major" />
                ...
                <tr>
                  <th>Minor</th>
                  <td><select type="text" name="new_aql_minor" id="new_aql_minor" class="form-control aql_select new_aql_minor"></select>
                  <div id="aqlRequired6" style="display:none" ><p style="color:red;">This field is required! </p></div>
                  </td>
                  <td><input type="text" name="new_max_minor" id="new_max_minor" class="form-control new_max_minor" />
        ...
        <div class="row">
          <div class="col-md-12">
              <table class="table-bordered table-condensed" width="100%">
                ...
                <tr>
                  <th>Normal</th>
                  <td><input type="text" name="new_aql_normal_letter" id="new_aql_normal_letter" class="form-control new_aql_normal_letter" >
                  <div id="aqlRequired8" style="display:none" ><p style="color:red;">This field is required! </p></div>
                  </td>
                  
                  <td><input type="text" name="new_aql_normal_sampsize" id="new_aql_normal_sampsize" class="form-control new_aql_normal_sampsize" />
                ...
                <tr>
                  <th>Special</th>
                  <td><input type="text" name="new_aql_special_letter" id="new_aql_special_letter" class="form-control new_aql_special_letter">
                  <div id="aqlRequired10" style="display:none" ><p style="color:red;">This field is required! </p></div>
                  </td>
                  
                  <td><input type="text" name="new_aql_special_sampsize" id="new_aql_special_sampsize" class="form-control new_aql_special_sampsize" />
