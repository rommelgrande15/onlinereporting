						...
						<div class="col-md-4">
							<div class="form-group">
								...
								{!! Form::select('p_unit', [
									...
									'kg' => 'Kilogram/s',
									'pack' => 'Pack/s',
		    						], $product->product_unit, ['class' => 'form-control p_unit psi_required psi_draft_required', 'placeholder'=>'Select Unit']) !!}
							</div>
						</div>
						<div class="col-md-4">
							<div class="form-group">
					...
					<div class="clone-inputs" style="display:none;">
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									<label for="new_product_category">Product Category</label><span class="error_messages category_error"></span>
									<select class="form-control new_product_category categories product_input"  name="new_product_category" required data-parsley-required-message="Please select a product category!" data-parsley-errors-container=".category_error">
										<option selected="selected" value="">Select a Category</option>
									</select>
								</div>
							</div>
...
function qtyPUS(){
        if (jQuery("#service").val() === 'pus' ) {
            ...
            jQuery('#qty').removedClass('aql_qty');
            jQuery('#qty').attr('readonly',false);
