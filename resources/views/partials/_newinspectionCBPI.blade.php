...
<div class="row">
    ...
    <div class="contact-select">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <select class="form-control client_select cli_required cli_draft_required" id="loading_client" name="loading_client" required>
                    <option value="" selected>Select Client</option> <!-- style="width:523.328px !important" -->
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                {!! Form::text('loading_reference_number', null, ['class' => 'cli_required form-control cli_draft_required', 'id'=>'loading_reference_number', 'readOnly'=>'true']) !!}
            </div>
        </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            {!! Form::text('loading_inspection_date', null, ['class' => 'form-control cli_required inspection_date cli_draft_required', 'id'=>'loading_inspection_date', 'autocomplete'=>'off']) !!}
        </div>
    </div>
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            {!! Form::text('loading_inspection_date_to', null, ['class' => 'form-control cli_required inspection_date cli_draft_required', 'autocomplete'=>'off']) !!}
        </div>
    </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            {!! Form::label('loading_inspector', '--Select Inspector Account for FM login details--') !!}

            <select class="form-control fm_inspector_cbpi" name="fm_inspector_cbpi" id="fm_inspector_cbpi" required>
        ...
        <input type="hidden" value="" id="fm_username_cbpi">
        <input type="hidden" value="" id="fm_password_cbpi">
    </div>
    <div class="col-md-12">
...
<div class="row" id="div_template_cbpi" style="display:none;">
    ...
    {{-- <div class="col-md-12">
		<label title="Checking this means the report is complex.">
			<input type="checkbox" id="complex_report_cbpi" name="complex_report_cbpi" value="0"> Complex Report (Check if complex, leave blank if not).
		</label>
	</div> --}}
...
<div class="row" id="div_template_word_cbpi" style="display:none;">
    <div class="col-md-4">
        <div class="form-group">
...
<script type="text/javascript">
    $(function() {
        ...
        $('#complex_report_cbpi').click(function() {
            if ($('#complex_report_cbpi').prop('checked') == true) {
                $('#complex_report_cbpi').val('1');
            } else {
                $('#complex_report_cbpi').val('0');
            }
        });
    });
...
$(document).ready(function(){
    ...
    $('#loading_client_old_function').on('change', function() {
    ...
    function cbpi_Inspector_Total_Cost_New2() {
        ...
        jQuery('#cbpi_cli_Total_Cost').val(total.toFixed(2))
    ...
    function cbpi_Inspector_Total_Cost_New() {
        ...
        jQuery('#cbpi_Inspector_Total_Cost').val(total.toFixed(2))
