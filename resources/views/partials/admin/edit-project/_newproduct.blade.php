      ...
      <div class="modal-body">
        <div class="form-group">
            <div class="form-group">
              ...
              <div id="productRequired1" style="display:none" ><p style="color:red;">This field is required!</p></div>
            </div>
            ...
            <div class="form-group">
              ...
              <select class="form-control categories product_input" id="new_product_category" name="new_product_category" required data-parsley-required-message="Please select a product category!" data-parsley-errors-container=".category_error">
            ...
            <div class="row">
              <div class="col-md-6">
                 <div class="form-group">
                    ...
                    <select class="form-control" id="unit" name="unit" required data-parsley-required-message="Please select a unit!" data-parsley-errors-container=".unit_error">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" name="new_po_number" class="form-control product_input" id="new_po_number" required data-parsley-required-message="Please enter the PO number!" data-parsley-errors-container=".po_error">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" name="new_model_number" class="form-control product_input" id="new_model_number" required data-parsley-required-message="Please enter the Model Number!" data-parsley-errors-container=".model_error">
                    <div class="input-group-btn">
              ...
              <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                    <input type="text" name="new_brand" class="form-control product_input" id="new_brand" required data-parsley-required-message="Please enter the Product Brand!" data-parsley-errors-container=".brand_error">
                    <div class="input-group-btn">
              ...
              <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="new_additional_product_info" class="form-control product_input" id="new_additional_product_info" required data-parsley-required-message="Please enter dditional information or put N/A if not applicable" data-parsley-errors-container=".brand_error">
                      <div class="input-group-btn">
