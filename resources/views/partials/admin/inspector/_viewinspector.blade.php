<div id="viewInspectorDetails" class="modal fade" role="dialog">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">View Inspector Details</h4>
      </div>
      <div class="modal-body">
        <div class="panel panel-primary main-content-panel">
          <div class="panel-heading">
            <h3 class="panel-title">View Inspector</h3>
          </div>
              ...
              <table class="table table-hover table-bordered" id="table_view_factory">
                <tbody>
                    <tr style="background-color:lightgrey">
                      <th colspan="4"><h4>1. Inspector Details</h4></th>
                    </tr>
                    <tr>
                      <th>Inspector Name :</th>
                      <td id="view_insp_name">data</td>
                      <th>Email Address :</th>
