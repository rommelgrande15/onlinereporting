<div id="newFactory" class="modal fade" role="dialog">
    ...
    {{--         <div class="col-md-12">
                ...
                <h4 class="modal-title">Factory Details</h4><br/>
              <div class="form-group">
                <label for="client"><span class="text-danger">*</span> Client / Company</label><span class="error_messages client_error"></span>
                <select class="form-control" required data-parsley-required-message="Please select a client!" onchange="textInputValidator(this.id)" data-parsley-errors-container=".client_error" id="client_code" name="client_code">
                <option value="">--Select Client--</option>
                  @foreach($clients as $client)
                    <option value="{{$client->client_code}}">{{$client->Company_Name}}</option>
                  @endforeach
                </select>
                <div id="factory0" style="display:none" ><p style="color:red;">This field is required! </p></div>
              </div>
  </div> --}}
  <div class="col-md-4">
...
{{--   <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="text" name="factory_address" class="form-control" onchange="checkeds2()" id="factory_address" required data-parsley-required-message="Please enter the factory address!" data-parsley-errors-container=".address_error">
                <div id="factory2" style="display:none" ><p style="color:red;">This field is required! </p></div>
              </div>
  </div> --}}
  ...
  {{-- <div class="col-md-4">
              <div class="form-group">
                ...
                <select class="form-control" required data-parsley-required-message="Please select a country!" onchange="checkeds2()" data-parsley-errors-container=".country_error" name="factory_country" id="factory_country">
  ...
  <div class="col-md-4">
    <div class="form-group">
      ...
      {{-- <select class="form-control" name="factory_state" id="factory_state">
   ...
   <div class="col-md-4">
    <div class="form-group">
      ...
      {{-- <select class="form-control" required data-parsley-required-message="Please select a city!" data-parsley-errors-container=".city_error" name="factory_city" id="factory_city" onchange="textInputValidator(this.id)">
  ...
  function checkeds2()
    ...
    /* 
      ...
      //alert("sds");
        ...
        if(jQuery('#'+idd[x]+'').val()=="")
        {
          jQuery('#factory'+x+'').css("display","block");
          ...
          $.ajaxSetup({
              ...
              var client_code =jQuery('#client_code').val();
              var factory_name = jQuery('#factory_name').val();
              var factory_address = jQuery('#factory_address').val();
              ...
              var factory_contact_skype= jQuery('#contact_skype').val();
              var factory_contact_wechat = jQuery('#contact_wechat').val();
              var factory_contact_whatsapp= jQuery('#contact_whatsapp').val();
              var factory_contact_qqmail = jQuery('#contact_qqmail').val();
              ...
              $.ajax({
                 ...
                 data:{
                   ...
                   factory_contact_skype:factory_contact_skype,
                   factory_contact_wechat:factory_contact_wechat,
                   factory_contact_whatsapp:factory_contact_whatsapp,
                   factory_contact_qqmail:factory_contact_qqmail  },
          ...
          var emailValidator=/^(([^<>()\[\]\.,;:\s@\"]+(\.[^<>()\[\]\.,;:\s@\"]+)*)|(\".+\"))@(([^<>()[\]\.,;:\s@\"]+\.)+[^<>()[\]\.,;:\s@\"]{2,})$/i;
            ...
            /*   var factory_country_name = jQuery('#factory_country option:selected').text();
              ...
              for(var i = 0; i < factory_contact_wechat.length; i++){
                ...
                /* if(g_data==""){
                  count_null+=1;
                  $(factory_contact_wechat[i]).css("border","1px solid red");
                }else{
                  $(factory_contact_wechat[i]).removeAttr("style");
                } */
              }
              ...
              for(var i = 0; i < factory_contact_whatsapp.length; i++){
                ...
                /* if(g_data==""){
                  count_null+=1;
                  $(factory_contact_whatsapp[i]).css("border","1px solid red");
                }else{
                  $(factory_contact_whatsapp[i]).removeAttr("style");
                } */
              }
              ...
              for(var i = 0; i < factory_contact_qqmail.length; i++){
                ...
                /* if(g_data==""){
                  count_null+=1;
                  $(factory_contact_qqmail[i]).css("border","1px solid red");
                }else{
                  $(factory_contact_qqmail[i]).removeAttr("style");
                } */
              }
 ...
 return true;
  ...
  $('.send-loading ').show();
              ...
              $.ajax({
                ...
                $('.send-loading ').hide();
                  alert("Factory successfully added.");
                  window.location.href = 'factorylist';
              },
              error: function(){
