					...
					<div class="clone-inputs-edit">					
						<input type="hidden" name="hidden_product_id" class="hidden_product_id" value="{{$product->id}}">
                            <div class="row" style="margin-left:0.5px;">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>System Report Number</label>
                                        <input type="text" name="reference_number" id="reference_number" class="form-control reference_number psi_required " value="{{$product->reference_number}}" required readOnly>
                                    </div>
                                </div>
                            </div>
							<div class="col-md-4">
...
<div class="col-md-offset-9 col-md-3">
	<br/>
        ...
        @foreach ($inspection_multiple as $mrn_id)
            <input type="hidden" name="mrn_inspection_id" class="mrn_inspection_id" value="{{$mrn_id->id}}">            
        @endforeach
        @foreach ($reports as $rep)
            <input type="hidden" name="report_id" class="report_id" value="{{$rep->id}}">            
        @endforeach
	</div>
</div>
