...
<div class="row">
	...
	<div class="col-md-6">
		<div class="form-group">
			{!! Form::label('loading_inspector_copy', '--Select Inspector Account for FM login details--') !!}

			<select class="form-control fm_inspector_cbpi_copy" name="fm_inspector_cbpi_copy" id="fm_inspector_cbpi_copy" required>
		...
		<input type="hidden" value="" id="fm_username_cbpi_copy">
		<input type="hidden" value="" id="fm_password_cbpi_copy">
	</div>
		<div class="col-md-12">
...
<div class="col-md-offset-9 col-md-3">
	...
	{!! Form::button('Save and Publish', ['class' => 'btn btn-success btn-block btn-cbpi-edit-submit','style'=>'margin-top: 5px;','type'=>'button', 'id'=>'btn-cbpi-copy']) !!}	
...
<script>
	...
	jQuery('#loading_client').on('change', function() {
	 ...
	 /*  jQuery('#CBPI_submit').click(function(e){
		...
		function setRefNumCBPIOldFunction(){
			var client_code=$('#loading_client').val();
		  if(client_code!=""){
			  var d = new Date();
