...
<div class="row" id="div_site_inspection">
	<div class="col-md-12">
	...
	<div class="col-md-4">
		...
		<div class="col-md-4">
			<div class="form-group">
					...
					<input type="text" name="site_reference_number" id="site_reference_number" class="form-control reference_number site_required site_draft_required" value="" required readOnly>
				</div>
		</div>
		...
		<div id="add_more_contact_container_site">
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<input type="text" name="client_project_number_site" id="client_project_number_site" class="form-control client_project_number site_required site_draft_required" value="" required>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
...
<div class="col-md-offset-9 col-md-3">
	<br/>
		...
		{!! Form::button('Save and Publish', ['class' => 'btn btn-success btn-block','id'=>'btn-site-submit-copy','type'=>'button']) !!}
...
<script>
	...
	jQuery('#site_client').on('change', function() {
	  ...
	  jQuery('#site_inspection_date').on('change', function() {
		var client_code = $('#site_client').val();
        var inspect_date_val = $('#site_inspection_date').val();
        if (client_code != "") {
            $.ajax({
