...
<div class="row">			
	...
	<div class="col-md-4">
		<div class="form-group">
			...
			<select class="form-control site_required client client_select site_draft_required select-clients" id="site_client" name="site_client" required>.
				...
				<div class="col-md-6">
					<div class="form-group">
					    {!! Form::label('site_inspector', 'Assign Inspector') !!}
					   	<select class="form-control select_address site_required site_draft_required site-sel-inspector select-inspectors" name="site_inspector" id="site_inspector" required>
...
<div class="row" id="div_template_site" style="display:none;">
	<div class="col-md-4">
		<div class="form-group">
			...
			<select class="form-control select-templates" name="site_template" id="site_template" required>
