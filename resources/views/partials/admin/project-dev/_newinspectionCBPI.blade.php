	...
	<div class="contact-select">
		...
		<div class="col-md-4">
			<div class="form-group">
			    ...
			    <select class="form-control client_select cli_required cli_draft_required" style="width:523.328px !important" id="loading_client" name="loading_client" required>
