...
<div class="row">
	...
	<div class="contact-select">
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<input type="text" name="reference_number" id="reference_number" class="form-control reference_number psi_required " value="" required readOnly>
			</div>
		</div>	
		...
		<div id="add_more_contact_container">
			...
			<div class="col-md-4">
				<div class="form-group">
					...
					<input type="text" name="client_project_number" id="client_project_number" class="form-control client_project_number psi_required " value="" required>
				</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
					<label>Inspection Date From</label>
					<input type="text" name="inspection_date" id="inspection_date" class="form-control inspection_date psi_required " value="" required>
			  	</div>
			</div>
			<div class="col-md-4">
				<div class="form-group">
					<label>Inspection Date To</label>
					<input type="text" name="inspection_date_to" id="inspection_date_to" class="form-control inspection_date psi_required " value="" required>
			  	</div>
			</div>
		</div>
	...
	<div class="col-md-4">
		<div class="form-group">
			...
			{!! Form::text('manday', 1, ['class' => 'form-control  manday psi_required ','required'=>'']) !!}
		</div>
	</div>
</div>
						...
						<div class="row">
							...
							<div class="col-md-4">
								<div class="form-group">
									...
									{!! Form::select('product_category', $p_category, $product->product_first_category, ['class' => 'form-control pcat product_input prod_valid s_pcat', 'placeholder'=>'Select Product Category']) !!}
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
