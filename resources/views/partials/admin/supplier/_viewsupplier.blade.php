<div id="viewSupplierDetails" class="modal fade" role="dialog">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-bordered" id="table_view_factory">
                <tbody>
                    ...
                    <tr>
                      <th>Supplier Code / Number :</th>
                      <td id="view_fac_number" colspan="3">data</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td id="view_fac_addr_eng" colspan="3">data</td>
                    </tr>


                    <tr>
                      <th>Supplier City (Local Language) :</th>
                      <td id="view_fac_addr_locall" colspan="3">data</td>
                    </tr>


                    <tr>
                      <th>Supplier Address (Local Language) :</th>
                      <td id="view_fac_addr_llcaol" colspan="3">data</td>
                    </tr>
