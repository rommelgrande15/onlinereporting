<div id="modalDeleteSupplierContactPerson" class="modal fade" role="dialog">
      ...
      <div class="modal-content">
          <form data-parsley-validate="">
              ...
              <div class="modal-header">
                  ...
                  <h4 class="modal-title">Delete <span id="delete_suppliercontact_name"></span> ?</h4>
              </div>
              <div class="modal-body">
                  <div class="row">
                      <div class="col-md-12">
                          <input type="hidden" name="delete_suppliercontact_id" class="form-control" id="delete_suppliercontact_id">
...
<script>
  jQuery(document).ready(function() {
      ...
      $('#btn_delete_contact').click(function() {
          ...
          $('.send-loading ').show();
          $.ajax({
              url: '/delete_SupplierContactPerson',
              type: 'POST',
              data: {
                  _token: token,
                  'delete_suppliercontact_id': $('#delete_suppliercontact_id').val()
              },
              beforeSend: function() {
                  $('.send-loading ').show();
              },
