			...
			<form method="post" action="" enctype="multipart/form-data" id="my-dropzone">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="refe_no" readonly>
					</div>
					<div class="form-group">
						<label for="">Client Email:</label>
						<input type="text" class="form-control add_report" placeholder="Client Email" id="company_email" name="company_email" autocomplete="off" readonly required>
					</div>
					<div class="form-group">
						<label for="">Add Recipient:</label>
						<input type="text" class="form-control add_report" placeholder="Recipient" id="recipient_email" autocomplete="off" autofocus required>
					</div>
					<div class="form-group">
						<label for="">Add Recipient CC:</label>
						<input type="text" class="form-control" placeholder="Recipient CC" id="cc_email" autocomplete="off">
					</div>
