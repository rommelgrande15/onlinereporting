...
<div class="row">
	...
	<div class="col-md-12">
	<h4 class="heading">Inspection Details FRI</h4>
	<hr>
	</div>

	<div class="col-md-4">
		<div class="form-group">
		    {!! Form::label('service_FRI', 'Service') !!}
		    {!! Form::select('service_FRI', [
				...
				'cbpi_isce' => 'CBPI - ISCE',
					...
					'SPK' => 'SPK',
					'FRI' => 'FRI',
		    ], null, ['class' => 'form-control service fri_required fri_draft_required', 'placeholder'=>'Select a Service', 'id'=>'service', 'required'=>'']) !!}
	  	</div>
		...
		<div class="col-md-4">
				<div class="form-group">
					...
					<select class="form-control fri_required client client_select fri_draft_required" id="client" name="client" required>.
	...
	<div class="col-md-4">
		<div class="form-group">
			...
			{!! Form::text('reference_number', null, ['class' => 'form-control reference_number fri_required fri_draft_required', 'id'=>'reference_number','required'=>'','readOnly'=>'true']) !!}
		</div>
	</div>
	...
	<div class="contact-select">
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<select class="form-control fri_required contact_persons fri_draft_required" id="contact_person"  name="contact_person">
		...
		<div class="col-md-4">
			<div class="form-group">
			    ...
			    {!! Form::text('contact_person_number', null, ['class' => 'form-control fri_required numeric contact_number fri_draft_required','required'=>'','id'=>'contact_number']) !!}
		  	</div>
		...
		<div class="col-md-4">
			<div class="form-group">
			    ...
			    {!! Form::text('contact_person_email', null, ['class' => 'form-control fri_required contact_email fri_draft_required','id'=>'email_address']) !!}
		  	</div>
...
<div class="col-md-4">
	<div class="form-group">
		...
		{!! Form::text('client_project_number', null, ['class' => 'form-control  client_project_number fri_required fri_draft_required','required'=>'','id'=>'client_project_number']) !!}
		</div>
...
<div class="col-md-4">
	<div class="form-group">
		...
		{!! Form::text('inspection_date', null, ['class' => 'form-control fri_required inspection_date fri_draft_required', 'id'=>'inspection_date','required'=>'']) !!}
	  </div>
...
<div class="col-md-4">
		<div class="form-group">
				{!! Form::label('FRI', 'FRI') !!}
			<select class="form-control select_address fri_required fri_draft_required sel-inspector" name="FRI" id="FRI" required>
		...
		<div class="clone-inspector">
			<div class="col-md-6">
				<div class="form-group">
				    {!! Form::label('inspector', 'Assign Inspector') !!}
				   	...
				   	<select class="form-control select_address fri_required fri_draft_required sel-inspector" name="inspector" id="inspector" required>
    		...
    		<div class="col-md-6">
				<div class="form-group">
				    ...
				    {!! Form::text('inspector_address', null, ['class' => 'form-control  inspector_address fri_required fri_draft_required insp-addr','required'=>'','id'=>'inspector_address','readOnly'=>'true']) !!}
				</div>
			</div>
		</div>
	</div>		
	...
	<div class="col-md-4">
		<div class="form-group">
			...
			{!! Form::text('manday', 1, ['class' => 'form-control  manday fri_required fri_draft_required','required'=>'','readOnly'=>'true']) !!}
		</div>
	</div>
...
<div class="row factory-select">
	...
	<div class="col-md-4">
		<div class="form-group">
			...
			<select class="form-control factory fri_required fri_draft_required" name="factory" id="factory" required>
	...
	<div class="col-md-8">
		<div class="form-group">
		    ...
		    {!! Form::text('factory_address', null, ['class' => 'form-control fri_required factory_address fri_draft_required','required'=>'','id'=>'factory_address','readOnly'=>'true']) !!}
	  	</div>
	...
	<div class="col-md-4">
		<div class="form-group">
			...
			<select class="form-control fri_required factory_contact_person fri_required fri_draft_required" id="factory_contact_person" name="factory_contact_person" >
	...
	<div class="col-md-4">
		<div class="form-group">
		    ...
		    {!! Form::text('factory_contact_number', null, ['class' => 'form-control fri_required numeric factory_contact_number fri_draft_required','required'=>'','id'=>'factory_contact_number','readOnly'=>'true']) !!}
	  	</div>
	</div>
	<div class="col-md-4">
		<div class="form-group">
		    {!! Form::label('factory_email', 'Email Address') !!}
		    {!! Form::text('factory_email', null, ['class' => 'form-control fri_required factory_email fri_draft_required','required'=>'','id'=>'factory_email','readOnly'=>'true']) !!}
	  	</div>
	</div>
...
<div class="row" id="products_list">
					...
					<div class="clone-inputs">
						<div class="col-md-3">
							<div class="form-group">
								{!! Form::label('product_name', 'Product Name') !!}
									<select class="form-control fri_required product_name fri_draft_required" name="product_name" id="product_name" required>
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								{!! Form::text('brand', null, ['class' => 'form-control brand fri_required fri_draft_required','required'=>'']) !!}
							</div>
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								{!! Form::text('po_number', null, ['class' => 'form-control po_number fri_required fri_draft_required','required'=>'']) !!}
							</div>
						...
						<div class="col-md-2">
							<div class="form-group">
								...
								{!! Form::text('model_no', null, ['class' => 'form-control model_no fri_required fri_draft_required','required'=>'']) !!}
							</div>
						...
						<div class="col-md-2 qty-modal">
							<div class="form-group">
								{!! Form::label('qty', 'Qty') !!}
								<div class="input-group">
									<input type="text" class="form-control qty fri_required fri_draft_required" name="qty" id="qty" readonly required>
									<div class="input-group-btn">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				...
				{!! Form::textarea('requirement', null, ['class' => 'form-control fri_required requirement','rows'=>'4']) !!}
			</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				...
				{!! Form::textarea('memo_psi', null, ['class' => 'form-control fri_required memo_psi','rows'=>'4']) !!}
			</div>
	...
	<div class="col-md-12">
			...
			<div class="col-md-12 dropzone-container file_upload_psi" id="file_upload_container">
						...
						<div class="fallback">
								<input name="file[]" class="fri_required joe file" type="file" id="file" multiple required />
						</div>
				...
				<div class="col-md-12">
						<div class="form-group">
							...
							<label class="checkbox-inline">
								<input type="radio" name="project_type" value="null" id="app_project" class="fri_required" onclick="changeProjectType('app')" required> APP Project
							</label>
							<label class="checkbox-inline">
								<input type="radio" name="project_type" value="null" id="word_project" class="fri_required" onclick="changeProjectType('word')" required> WORD Project
							</label>
