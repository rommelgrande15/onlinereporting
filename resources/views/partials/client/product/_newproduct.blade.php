			...
			<form id="id_dropzone" action="/dropzoneupload/" enctype="multipart/form-data" method="post">
				<div class="modal-body ">
					...
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="supplier_item_no">Supplier item no.</label>
								<input type="text" name="supplier_item_no" class="form-control" id="supplier_item_no" required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="new_brand" class="form-control product_input new_brand new_product add_product" id="new_brand" required data-parsley-required-message="Please enter the Product Brand!" data-parsley-errors-container=".brand_error">
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="input-group">
									{!! Form::select('new_product_category', $p_category, null, ['class' => 'form-control product_category add_product', 'placeholder'=>'Select Product Category']) !!}
						...
						<div class="col-md-6">
							<div class="form-group" id="sortt">
								...
								<div class="input-group">
									<select class="form-control product_sub_category add_product" id="new_product_sub_category" name="new_product_sub_category">
						...
						<div id="logistic_product" class="logistic_div hidden">
							...
							<!-- <div class="col-md-6">
								<div class="form-group">
									<label for="new_prod_max_weight">Max. weight of export carton (kg)</label>
									<input type="text" name="new_prod_max_weight" class="form-control" id="new_prod_max_weight">
								</div>
							</div> -->
							<div class="col-md-12">
								<hr/>
						...
						<div id="logistic_retail" class="logistic_div hidden">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="new_retail_qty">Retail Box Quantity</label>
									<input type="number" name="new_retail_qty" class="form-control" id="new_retail_qty">
								</div>
							</div>
<!-- 							<div class="col-md-6">
								<div class="form-group">
									<label for="new_retail_max_weight">Max. weight of export carton (kg)</label>
									<input type="text" name="new_retail_max_weight" class="form-control" id="new_retail_max_weight">
								</div>
							</div> -->
							<div class="col-md-12">
								<hr/>
						...
						<div id="logistic_inner" class="logistic_div hidden">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="new_inner_qty">Inner Box Quantity</label>
									<input type="number" name="new_inner_qty" class="form-control" id="new_inner_qty">
								</div>
							</div>
							<!-- <div class="col-md-6">
								<div class="form-group">
									<label for="new_inner_max_weight">Max. weight of export carton (kg)</label>
									<input type="text" name="new_inner_max_weight" class="form-control" id="new_inner_max_weight">
								</div>
							</div> -->
							<div class="col-md-12">
								<hr/>
						...
						<div id="logistic_export" class="logistic_div hidden">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="new_export_qty">Export Box Quantity</label>
									<input type="number" name="new_export_qty" class="form-control" id="new_export_qty">
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="new_export_cbm">Export Carton CBM</label>
									<input type="text" name="new_export_cbm" class="form-control" id="new_export_cbm">
								</div>
							</div>
							<div class="col-md-12">
								<hr/>
						...
						{{-- <div class="col-md-12">
							<div class="form-group">
								<label for="new_grd">Goods Ready Date</label>
								<input type="text" name="new_grd" class="form-control" id="new_grd">
								{{-- <label for="new_grd">Goods Ready Date</label>
						...
						<div class="col-md-12">
							<div class="form-group">
								...
								<!-- <input type="text" name="new_item_desc" class="form-control" id="new_item_desc"> -->
							</div>
						</div>
						...
						{{-- <div class="col-md-6">
							<div class="form-group">
								<label for="new_product_number">Product Number</label><span class="error_messages product_error"></span>
								<div id="product_num_container">
								</div>
								<input type="text" name="new_product_number" class="form-control product_input new_product_number new_product" id="new_product_number" required data-parsley-required-message="Please enter the Model Number!" data-parsley-errors-container=".model_error">
...
$("#modalInputNewSubCat").on('hidden.bs.modal', function (event) {
  if ($('.modal:visible').length) {
    $('body').addClass('modal-open');
  }
});
...
$("#btn_log_prod").click(function (event) {
	...
	//$('#logistic_retail').addClass('hidden');
	//$('#logistic_inner').addClass('hidden');
	//$('#logistic_export').addClass('hidden');
...
$("#btn_log_retail").click(function (event) {
	/* $('#logistic_product').addClass('hidden');
...
$("#btn_log_export").click(function (event) {
	...
	if($('#logistic_export').hasClass('hidden')){
		...
		var select = $('new_product_sub_category');
		...
		$('#save_product').click(function() {
			var checkDuplicateProduct = 0;
			$('#add-show-error').hide();
			$.ajax({
				url: '/getproductbyclientcode/' + $('#new_client_code_product').val() + '',
				type: 'GET',
		...
		function savealldata() {
			...
			$.ajax({
				...
				data: {
					...
					'retail_box_qty': $('#new_retail_qty').val(),
					...
					'inner_box_qty': $('#new_inner_qty').val(),
					...
					'export_box_qty': $('#new_export_qty').val(),
					'export_max_weight': $('#new_export_max_weight').val(),
					'export_cbm': $('#new_export_cbm').val(),
					'grd': $('#new_grd').val(),
