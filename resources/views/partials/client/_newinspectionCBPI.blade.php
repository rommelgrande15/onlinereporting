{!!Form::open(['enctype'=>'multipart/form-data','id'=>'new_loading_form','data-parsley-validate'=>'', 'route'=>'savecbpiinspection','class'=>'form-inspection'])!!}
	<div class="row">
		...
		<div class="contact-select">
			...
			<div class="col-md-12">
				<div class="form-group">
					<button style="margin-left:20px;" class="btn btn-primary btn-contact-person pull-right" type="button"><i class="fa fa-list-alt"></i> List of Contact Persons</button>
				</div>
			</div>
		</div>
	...
	<div class="row factory-select">
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				<select class="form-control supplier cli_required" name="loading-supplier" id="loading-supplier" required>
		...
		<div class="col-md-4">
			<div class="form-group">
			    {!! Form::label('supplier_code_cli', 'Supplier Code / Number') !!}
			    {!! Form::text('supplier_code_cli', null, ['class' => 'form-control supplier_code','required'=>'','readOnly'=>'true']) !!}
		  	</div>
		</div>
		<div class="col-md-4">
			<div class="form-group">
				{!! Form::label('supplier_address', 'Supplier Address') !!}
				{!! Form::text('supplier_address', null, ['class' => 'form-control cli_required supplier_address cli_draft_required','required'=>'','readOnly'=>'true']) !!}
			  </div>
		</div>
		<div class="col-md-4">
			<div class="form-group">
