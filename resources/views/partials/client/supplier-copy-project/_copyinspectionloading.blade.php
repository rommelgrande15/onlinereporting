{!!Form::open(['enctype'=>'multipart/form-data','id'=>'new_loading_form','data-parsley-validate'=>'', 'route'=>'savecbpiinspection','class'=>'form-inspection'])!!}
	<div class="row">		
		<div class="col-md-12">
			...
			<h4 style="color:green;"><span class="pull-right">Client Name : {{ $clientName->client_name }}</span></h4>
		</div>
		<div class="row">
			<div class="col-md-4">
	...
	<div class="row factory-select">
		...
		<div class="col-md-4">
			<div class="form-group">
                ...
                {!! Form::text('loading-supplier-name',  $supplierData->supplier_name , ['class' => 'form-control cli_required numeric loading-supplier-name cli_draft_required','required'=>'','readOnly'=>'true']) !!}
		  	</div>
		</div>
		<div class="col-md-8">
			<div class="form-group">
				...
				@if($supplier_info)
					{!! Form::text('supplier_address', $supplierData->supplier_address, ['class' => 'form-control cli_required supplier_address cli_draft_required','readOnly'=>'true']) !!}
				@else
