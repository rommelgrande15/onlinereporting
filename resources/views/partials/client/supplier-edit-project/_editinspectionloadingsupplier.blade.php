{!!Form::open(['enctype'=>'multipart/form-data','id'=>'new_loading_form','data-parsley-validate'=>'', 'route'=>'supplier-editloadinginspection','class'=>'form-inspection'])!!}
	<div class="row">		
		<div class="col-md-12">
			<h4 class="heading">Inspection Details</h4>
			<h4 style="color:green;"><span class="pull-right">Client Name : {{ $clientName1->client_name }}</span></h4>
		</div>
		...
		<input type="hidden" value="{{$inspection->reference_number}}" class="form-control loading_reference_number" id="loading_reference_number">
		<div class="col-md-4">
			<div class="form-group">
				{!! Form::label('client_project_number_cbpi', 'Order Number') !!}
				{!! Form::text('client_project_number_cbpi', $inspection->client_project_number, ['class' => 'form-control  client_project_number_cbpi cli_required cli_draft_required','required'=>'']) !!}
				<br/><br/><br/>				
			</div>
		</div>
		<div class="col-md-4">
		...
		<div class="contact-select">	
			<div class="clone-inputs-contact-person">
				<div class="col-md-4">
					<div class="form-group">
						{!! Form::label('loading_contact_person', 'Client Contact Person') !!}
						{{-- {!! Form::select('loading_contact_person', $supplierContactNew, $get_cc->id, ['class' => 'form-control cli_required contact_persons cli_draft_required', 'placeholder'=>'Select Contact']) !!} --}}
						{!! Form::text('loading_contact_person',  $get_cc->contact_person , ['class' => 'form-control cli_required contact_persons cli_draft_required','required'=>'','id'=>'loading_contact_person','readOnly'=>'true']) !!}
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
	...
	<div class="row factory-select">
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				{!! Form::hidden('loading-supplier',$inspection->supplier_id, ['class' => 'form-control supplier cli_required cli_draft_required']) !!}
                {!! Form::text('loading-supplier-name',  $supplierData->supplier_name , ['class' => 'form-control cli_required numeric loading_supplier_name cli_draft_required','required'=>'','readOnly'=>'true']) !!}
		  	</div>
		</div>
		<div class="col-md-8">
			<div class="form-group">
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				{!! Form::text('loading_supplier_contact_person',  $supplier_con_info->supplier_contact_person, ['class' => 'form-control supplier_contact_person cli_required cli_draft_required','required'=>'','id'=>'loading_supplier_contact_person','readOnly'=>'true']) !!}
		  	</div>
		</div>
		<div class="col-md-4">
			<div class="form-group">
	...
	<div class="">
		<div class="col-md-offset-10 col-md-2">
			...
			<input type="hidden" id="loading_client" value="{{$supplierData->client_code}}">
			<input type="hidden" id="hidden_client_code" value="{{$supplierData->client_code}}">
			<input type="hidden" id="edit_inspection_id" value="{{$inspection->id}}">
			<input type="hidden" id="loading_client_cp" value="{{$inspection->contact_person}}">
			<input type="hidden" id="loading_supplier_cp" value="{{$inspection->supplier_contact_id}}">
