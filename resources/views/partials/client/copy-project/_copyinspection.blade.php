		...
		<div class="row">
			<div class="col-md-4">
				<div class="form-group" style="margin-left:18px;">
				    ...
				    {!! Form::select('service', $services, $inspection->service, ['class' => 'form-control service psi_required psi_draft_required', 'placeholder'=>'Select a Service', 'id'=>'service', 'readOnly'=>true]) !!}
			  	</div>
			</div>
		</div>
