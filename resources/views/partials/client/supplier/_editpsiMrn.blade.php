{!!Form::open(['id'=>'new_inspection_form','data-parsley-validate'=>'', 'route'=>'supplier-editinspection-mrn','class'=>'form-inspection','enctype'=>'multipart/form-data'])!!}
	<div class="row">		
		<div class="col-md-12">
	...
	<div class="row factory-select">
		...
		<div class="col-md-4">
			<div class="form-group">
				...
				{{-- {!! Form::select('supplier_contact_person', $supplier_con_info->supplier_contact_person, ['class' => 'form-control supplier_contact_person psi_required psi_draft_required', 'placeholder'=>'Select Supplier Contact Person']) !!} --}}
	...
	<div id="products_list">
                        ...
                        <div class="row" style="margin-left:0.5px;">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="reference_number" id="reference_number" class="form-control reference_number psi_required psi_draft_required" value="{{$psi->reference_number}}" required readOnly>
                                </div>
                            </div>
                        </div>
		...
		<div class="col-md-4 pull-right">
				<button type="button" class="btn btn-info pull-right" id="btn_product_new">
	...
	<div class="">
		<div class="col-md-offset-10 col-md-2">
            ...
            @foreach ($inspection_multiple as $mrn)
                <input type="hidden" class="mrn_inspection_id" value="{{$mrn->id}}">
            @endforeach
