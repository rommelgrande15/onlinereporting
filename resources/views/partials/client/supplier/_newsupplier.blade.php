			...
			<form data-parsley-validate='' method="POST" action="" id="form_add_supplier">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="supplier_code"><span class="text-danger">*</span> Supplier Number / Code</label>
								<input type="text" name="supplier_code" class="form-control validate_input" id="supplier_code" required>
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="supplier_city" class="form-control" id="supplier_city">
							</div>
						</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="supplier_local_city" class="form-control" id="supplier_local_city">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
						...
						<div class="col-md-12">
						  ...
						  <div class="product-clone">
							<div class="clone-inputs col-md-12">
								<label class="checkbox-inline checkbox-bootstrap checkbox-lg">
									<input type="checkbox" id="SupplierAccountViewBtn">
									<span class="checkbox-placeholder"></span>
									Checked if need Supplier Account
								  </label>
							</div>
								...
								<div class="form-group col-md-12" id ="AccountSupplierViewPanel" style="display:none">
									<div class="col-md-12">
										<div class="form-group">
											<hr />
										</div>
...
<script>
	$(document).ready(function() {
		...
		$('#SupplierAccountViewBtn').click(function() {
    		if($("#SupplierAccountViewBtn").is(':checked')){
				$('#AccountSupplierViewPanel').show();
				$('#username').addClass("validate_input");
				$('#email').addClass("validate_input");
				$('#password').addClass("validate_input");
				$('#password_confirmation').addClass("validate_input");
				$('#contact_number').addClass("validate_input");
				$('#account_name').addClass("validate_input");
				$('#email_reciever').addClass("validate_input");
				$('#report_access').addClass("validate_input");
				$('#no_email').addClass("validate_input");
				$('#validate_input').addClass("validate_input");
			}
    		else{
				$('#AccountSupplierViewPanel').hide();
				$('#username').removeClass("validate_input");
				$('#email').removeClass("validate_input");
				$('#password').removeClass("validate_input");
				$('#password_confirmation').removeClass("validate_input");
				$('#contact_number').removeClass("validate_input");
				$('#account_name').removeClass("validate_input");
				$('#email_reciever').removeClass("validate_input");
				$('#validate_input').removeClass("validate_input");
			}	
		});
	...
	function savesupplierDetails() {
		...
		if($("#SupplierAccountViewBtn").is(':checked')){
			...
			validate_input = $('#validate_input').val();
			...
			var supplier_number = jQuery('#supplier_code').val();
