<div id="newFactory" class="modal fade" role="dialog">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="form-group">
                ...
                <input type="hidden" name="supplier" class="form-control validate_input supplier" id="supplier" value="">
                <input type="hidden" name="factory_count" class="form-control validate_input factory_count" id="factory_count" value="">
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
            ...
            <div class="product-clone-factory" id="f_contact_div">
              <div class="clone-inputs-contacts">
                <div class="col-md-12">
  ...
  function saveFactoryDetailsSupplier(){      
    $('.send-loading ').show();
   ...
   /*  var factory_state = jQuery('#factory_state').val(); */
    ...
    $.ajax({
      type:'POST',
      url:'/client-postnewfactory-supplier',
      data:{
        _token: token,
    ...
    function showAllCountryFactory(){
...
$('#factory_state').autocomplete({
  ...
  function getSupplierdetails(){
    var supplier_id = jQuery('#supplier').val();  
          $.ajax({
                url: '/getonesupplierforfactory/' + supplier_id,
                type: 'GET',
...
$( "#factory_city" ).autocomplete( "option", "appendTo", ".eventInsForm" );
      ...
      $('#btn_add_more_fields').click(function() {
          $('.clone-inputs-contacts:first').clone().appendTo('.product-clone-factory').find("input").val("");
          $('.clone-inputs-contacts:last').append('<div class="col-md-4">' +
      ...
      $('body').on('click', '.btn-rm', function() { 
        $(this).closest('.clone-inputs-contacts').remove();
      });
