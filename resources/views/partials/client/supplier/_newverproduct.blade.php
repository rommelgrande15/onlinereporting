				...
				<div class="modal-body ">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<input type="hidden" name="new_client_code_product" id="new_client_code_product" value="{{$cname->client_code}}">
							@endforeach
		...
		function savealldata() {
			...
			$.ajax({
				...
				success: function(response) {
					...
					$('.send-loading ').hide();
					$('.product_name_new').append('<option value="'+response.product_id+'">'+$('#new_product_name').val()+'</option>');
					swal({
						title: "Success!",
