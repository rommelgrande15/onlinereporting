<div id="newFactory" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="col-md-12" id="chckBox">
          ...
          <div class="factory-clone" id="f_contact_div">
  ...
  <script>
    ...
    $('#check_supplier').click(function() {
         ...
         $('#f_btn_add_more_fields').attr('disabled','disabled');
			} else {
				$(this).val('false');
          $('#factory_name').val('');
          $('#factory_number').val('');
          ...
          $('#f_btn_add_more_fields').attr('disabled',false);
			}
      }
		})
    ...
    var supplier_id = jQuery('#supplier').val();  
          $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#factory_address2').val(response.supplier.supplier_address);
