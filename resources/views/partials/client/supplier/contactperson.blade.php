<div id="contact-person-modal-supplier" class="modal fade" role="dialog">
  ...
  <script>
   ...
   function setEnEy(cb_id,text_id,group_class,btn_id){
    ...
    function updateContactData(contact_id){
        var add_client_code =$('#loading_client').val();
        ...
        $.ajax({
         type:'POST',
         url:'/client-supplierupdateclientcontact',
         data:
         {
    ...
    $('#btn-save-new-contact').click(function(){
      ...
      if(count_null==0 && email_err==0){
        ...
        $.ajax({
         type:'POST',
         url:'/client-supplieraddclientcontact',
         data:
         {
            client_code:add_client_code,
            contact_person:add_contact_person,
    ...
    function getClientContactList(){
        ...
        $.ajax({
         type:'GET',
         url:'/get-supplier-client-contacts/'+client_code,
         success:function(data){
          console.log(data);
