<div class="modal fade AQLModal" role="dialog">
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
            @foreach($client_aql_detail as $aql)
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @if ($aql)
                                    {!! Form::select('aql_normal_level', $normal, $aql->normal_level, ['class' => 'form-control aql_normal_level', 'placeholder'=>'--Select--', 'required'=>'']) !!}
                                @else
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @if ($aql)
                                    {!! Form::select('aql_special_level', $special, $aql->special_level, ['class' => 'form-control aql_special_level', 'placeholder'=>'--Select--', 'required'=>'']) !!}
                                @else
                            ...
                            <table class="table-bordered table-condensed row_aql_modal" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if ($aql)
                                        <input type="hidden" class="preset_aql_major" id="preset_aql_major" value="{{$aql->aql_major}}">
                                        @endif
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if ($aql)
                                        <input type="hidden" class="preset_aql_minor" id="preset_aql_minor" value="{{$aql->aql_minor}}">
                                        @endif
