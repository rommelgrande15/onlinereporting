        ...
        <div class="modal-body">
          <div class="row">   
            ...
            <div class="col-md-6">
             ...
             <!-- <div class="col-md-4">
                <div class="form-group">
                  <label for="update_factory_state">Enter State</label>
                  <input type="text" class="form-control validate_input" required name="update_factory_state" id="update_factory_state">
                  <input type="hidden" class="form-control" name="update_factory_state_id" id="update_factory_state_id">
                </div>
              </div>           
              <div class="col-md-4">
                <div class="form-group">
                  <label for="update_factory_city">Enter City</label>
                  <input type="text" class="form-control validate_input" required id="update_factory_city" >
                </div>
              </div>-->
