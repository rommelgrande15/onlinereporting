<div id="newFactory" class="modal fade" role="dialog">
    ...
    <div class="modal-content">
      ...
      <form data-parsley-validate='' method="POST" action="" id="form_add_factory">
        ...
        <div class="modal-body">
          <div class="col-md-12" id="chckBox">
            <div class="checkbox">
              <label><input type="checkbox" value="false" id="check_supplier">Please check if this factory is same as supplier.</label>
            </div>
          </div> 
          <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label for="factory_address_local"><span class="text-danger">*</span> Factory Address (English)</label>
                <input type="text" name="factory_address" class="form-control validate_input" id="factory_address" required>
              </div>
            </div>
            ...
            {{-- <div class="col-md-12">
              <div class="checkbox" id="factory_account_div">
                <label class="checkbox-bootstrap checkbox-lg">                           
                    <input type="checkbox" id="factory_account">             
            ...
            {{-- <div id="factory_account_view" class="form-group" style="display: none;">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Add Factory Account</h4>
              </div>
              <div class="modal-body">
                {!!csrf_field()!!}
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control validate_input" id="username" name="username" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="email" class="form-control validate_input" name="email" id="email" required>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control validate_input" minlength="6" id="password" name="password" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="password_confirmation">Confirm Password</label>
                      <input type="password" class="form-control validate_input" id="password_confirmation" name="password_confirmation">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="text" minlength="11" maxlength="15" class="form-control numeric validate_input" name="contact_number" id="contact_number" required>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="email">Account Name:</label>
                      <input type="text" class="form-control validate_input" name="account_name" id="account_name" required>
                    </div>
                  </div>
                </div>
           ...
           <!-- <div class="col-md-4">
              ...
              <button class="btn btn-success" type="button" id="btn_add_more_map"><i class="fa fa-plus"></i> Show Map</button>
           ...
           <!-- <div class="col-md-4">
              <div class="form-group">
                <label for="factory_state"><span class="text-danger">*</span> Enter State</label>
                <input type="text" class="form-control validate_input" name="factory_state" id="factory_state" required>
                <input type="hidden" class="form-control" name="hidden_factory_state_id" id="hidden_factory_state_id" required>
              </div>
            </div>
          <div class="col-md-4">
            <div class="form-group">
              <label for="factory_city"><span class="text-danger">*</span> Enter City</label> 
              <input type="text" class="form-control validate_input" required  name="factory_city" id="factory_city">         
            </div>
          </div>-->
          ...
          <div class="product-clone" id="f_contact_div">
      ...
      <input type="hidden" name="hidden_supplier_id" id="hidden_supplier_id" value="{{$suppliers->id}}">
      <input type="hidden" name="fact_count" id="fact_count" value="{{$f_count}}">
      </div>
    </form>
  </div>
</div>
  ...
  <script>
    $(document).ready(function(){
      ...
      $('#factory_account').click(function() {
        if(this.checked){
          $("#factory_account_view").show();  // checked
        }        
        else{
        $("#factory_account_view").hide(); 
        }
    ...
    //05-21-2021
    $('#check_supplier').click(function() {
			if (this.checked) {
				$(this).val('true');
         getSupplierdetails();
         $('#supplier_contacts_div').show();
         $('.product-clone').hide();
         $('.contact_person').removeClass("validate_input");
         $('.contact_person_email').removeClass("validate_input_email");
         $('.contact_person_number').removeClass("validate_input");
         $('.f_contact_person_tel_number').removeClass("validate_input");
         $('#btn_add_more_fields').attr('disabled','disabled');
			} else {
				$(this).val('false');
          $('#factory_name').val('');
          $('#factory_number').val('');
          $('#factory_address').val('');
          $('#factory_address_local').val('');
          $('#factory_country').val('');
          $('#factory_city').val('');
          $('#factory_city_local').val('');
          $('#factory_address_local').val('');
          $('#supplier_contacts_div').hide();
          $('.product-clone').show();
          $('.contact_person').addClass("validate_input");
         $('.contact_person_email').addClass("validate_input_email");
         $('.contact_person_number').addClass("validate_input");
         $('.f_contact_person_tel_number').addClass("validate_input");
         $('#btn_add_more_fields').attr('disabled',false);
			}
		})
  ...
  function saveFactoryDetails(){      
    ...
    var supplier_id = jQuery('#hidden_supplier_id').val();
   ...
   /*  var factory_state = jQuery('#factory_state').val(); */
    ...
    var factory_address = jQuery('#factory_address').val();//eng
    ...
    var checkSupplier =  $('#check_supplier').val();
    if(checkSupplier=='true'){
        ...
        var f_contact_person_tel_number = jQuery('.contact_person_tel_number');
        var factory_contact_skype= jQuery('.f_contact_skype');
        var factory_contact_wechat = jQuery('.f_contact_wechat');
        var factory_contact_whatsapp= jQuery('.f_contact_whatsapp');
        var factory_contact_qqmail = jQuery('.f_contact_qqmail');
    }else{
...
$('#factory_state').autocomplete({
  ...
  function getFactoryCount(){
    var fc = jQuery('#fact_count').val();
    if(fc=='0' || fc==0){
      // $('#chckBox').show();
      $("#check_supplier").attr('disabled',);
    }else{
      // $('#chckBox').hide();
  ...
  function getSupplierdetails(){
    var supplier_id = jQuery('#hidden_supplier_id').val();  
          $.ajax({
                url: '/getonesupplier/' + supplier_id,
                type: 'GET',
                success: function(response) {
                    console.log(response);

                    $('#supplier_contacts_div').empty();
                    ...
                    $.each(response.contacts, function(i, element) {
                        if (element.supplier_contact_status != 2 || element.supplier_contact_status != '2') {
                            ...
                            $('#supplier_contacts_div').append('<div id="' + element.id + '"><div class="col-md-12">' +
                                // '        <div class="form-group">' +
                                // '          <hr/>' +
                                // '      </div>' +
                                '    </div>' +
                                ...
                                '          <input type="text" name="f_contact_person" value="' + element.supplier_contact_person + '" onchange="test2()" id="f_contact_person' + element.id + '" class="form-control f_contact_person validate_input" required>' +
                                ...
                                '    <div class="col-md-4">' +
                                '      <div class="form-group">' +
                                '          <label for="f_contact_person_email">Email Address</label>' +
                                '          <input type="email" name="f_contact_person_email" value="' + element.supplier_email + '" onchange="test2()" id="f_contact_person_email' + element.id + '" class="form-control f_contact_person_email validate_input_email" required>' +
                                ...
                                '    <div class="col-md-4">' +
                                '      <div class="form-group">' +
                                '          <label for="f_contact_person_number">Mobile Number</label>' +
                                '          <input type="text" name="f_contact_person_number" value="' + element.supplier_contact_number + '" onchange="test2()" id="f_contact_person_number' + element.id + '" class="form-control numeric f_contact_person_number validate_input" required>' +
                                ...
                                '    <div class="col-md-4">' +
                                '      <div class="form-group">' +
                                '          <label for="contact_person_tel_number">Telephone Number</label>' +
                                '          <input type="text" name="contact_person_tel_number" value="' + element.supplier_tel_number + '" onchange="test2()" id="contact_person_tel_number' + element.id + '" class="form-control numeric contact_person_tel_number validate_input" required>' +
                                ...
                                '    <div class="col-md-4">' +
                                '        <div class="form-group">' +
                                '            <label for="f_contact_skype">Skype</label>' +
                                '            <input type="text" name="f_contact_skype" value="' + element.supplier_contact_skype + '"  id="f_contact_skype' + element.id + '" class="form-control f_contact_skype" required>' +
                                ...
                                '      <div class="col-md-4">' +
                                '          <div class="form-group">' +
                                '              <label for="f_contact_wechat">We Chat</label>' +
                                '              <input type="text" name="f_contact_wechat"  value="' + element.supplier_contact_wechat + '" id="f_contact_wechat' + element.id + '" class="form-control f_contact_wechat" required>' +
                                ...
                                '        <div class="col-md-4">' +
                                '            <div class="form-group">' +
                                '                <label for="f_contact_whatsapp">WhatsApp</label>' +
                                '                <input type="text" name="f_contact_whatsapp" value="' + element.supplier_contact_whatsapp + '" id="f_contact_whatsapp' + element.id + '" class="form-control f_contact_whatsapp" required>' +
                                ...
                                '          <div class="col-md-4">' +
                                '              <div class="form-group">' +
                                '                  <label for="f_contact_qqmail">QQ Mail</label>' +
                                '                  <input type="text" name="f_contact_qqmail"  value="' + element.supplier_contact_qq + '" id="f_contact_qqmail' + element.id + '" class="form-control f_contact_qqmail" required>' +
                    ...
                    $('#factory_name').val(response.supplier.supplier_name);
                    $('#factory_number').val(response.supplier.supplier_number);
                    $('#factory_address').val(response.supplier.supplier_address);
                    $('#factory_address_local').val(response.supplier.supplier_address_local);
                    $('#factory_country').val(response.supplier.supplier_country);
                    $('#factory_city').val(response.supplier.supplier_city);
                    $('#factory_city_local').val(response.supplier.supplier_local_city);
                    $('#factory_address_local').val(response.supplier.supplier_local_address);
                }
