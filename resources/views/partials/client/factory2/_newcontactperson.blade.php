    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
          <div class="col-md-12 label-warning">
            <h4 class="modal-title">Add Factory Contact Person</h4>
          </div>
      </div>
...
$('#addFactoryContactPerson').modal('toggle');
 ...
 $.ajax({
        url: '/viewsupplier-factory/' + $('#hidden_factory_id').val(),
        type: 'GET',
...
console.log(checked);
  ...
  $('.send-loading ').show();
      $.ajaxSetup({
            ...
            $.ajax({
               type:'POST',
               url:'/postnewsupplierfactorycontact',
               data:
               {
               ...
               success:function(data){ 
                 $('.send-loading ').hide();
                  swal({
                  title: "Success",
                  text: "Factory Contact Successfully Added!",
                  icon: "success",
                },function() {
                  ...
                  $('#addFactoryContactPerson').modal('hide');
                  location.reload();
                });
