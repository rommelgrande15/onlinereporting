    ...
    function checkeds2()
     ...
     function saveFactoryDetails()
     {
      ...
      var supplier_id =jQuery('#supplier_id').val(); 
            ...
            var factory_city_local =  jQuery('#factory_city_local').val();

            var factory_address = factory_city +', ' +factory_country_name;
          ...
          var array_id_name = ['client_code','supplier_id','factory_name','factory_address_local','factory_country','factory_state','factory_city','contact_person','contact_person_email','contact_person_number','f_contact_person_tel_number'];
    var message_array = ['client_code','supplier_id','factory name','factory address_local','factory country','factory state','factory city','contact person','contact person email','contact person number','Factory contact person tel. number'];
