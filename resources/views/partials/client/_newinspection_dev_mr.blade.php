{!!Form::open(['id'=>'new_inspection_form','data-parsley-validate'=>'', 'route'=>'saveinspection','class'=>'form-inspection','enctype'=>'multipart/form-data'])!!}
	...
	<div class="row factory-select">
		...
		<div class="col-md-12 text-right">
			<div class="form-group">
				@if($create_supplier=="" || $create_supplier=="yes")
				...
				@else
					<button style="margin-left:20px;"  class="btn btn-primary btn-supplier disabled" type="button"><i class="fa fa-plus"></i> Add New Supplier</button>
				@endif
			</div>
		</div>
		...
		<div class="col-md-4">
			<div class="form-group">
			    ...
			    {!! Form::text('supplier_code', null, ['class' => 'form-control supplier_code','required'=>'','readOnly'=>'true']) !!}
		  	</div>
		</div>
		<div class="col-md-4">
			<div class="form-group">
				...
				<div class="group-body product-with-report">
					...
					<div class="row product-clone">
						<div class="clone-inputs">
							...
							<div class="col-md-4 qty-modal">
								...
								@include('partials.client._newinspectionmodal')
							</div>
					...
					<div class="row">
						<div class="col-md-4 pull-right">
							<button type="button" class="btn btn-info pull-right btn-add-more-product" id="btn_product_old" style="margin-top:2rem;">
