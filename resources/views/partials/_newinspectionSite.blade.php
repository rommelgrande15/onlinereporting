...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            ...
            {!! Form::text('site_reference_number', null, ['class' => 'form-control reference_number site_required site_draft_required', 'id'=>'site_reference_number','required'=>'','readOnly'=>'true']) !!}
        </div>
    </div>
...
<script>
    function site_Inspector_Total_Cost_New2() {
        ...
        jQuery('#site_cli_Total_Cost').val(total.toFixed(2))
    ...
    function site_Inspector_Total_Cost_New() {
        ...
        jQuery('#site_Inspector_Total_Cost').val(total.toFixed(2))
    ...
    $(document).ready(function() {
        ...
        $('#site_client_old_function').on('change', function() {
