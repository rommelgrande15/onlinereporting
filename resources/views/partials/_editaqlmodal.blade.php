        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="number" class="form-control e_aql aql_qty" name="aql_qty" id="aql_qty" required>
          ...
          <div class="col-md-6">
            ...
            <select class="form-control aql_qty_unit e_unit" id="aql_qty_unit" name="aql_qty_unit" required>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="form-control aql_normal_level e_anlvl" name="aql_normal_level" id="aql_normal_level" required>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="form-control aql_special_level e_aslvl" name="aql_special_level" id="aql_special_level" required>
                <option value="">--Select--</option>
          ...
          <div class="col-md-12">
              <table class="table-bordered table-condensed" width="100%">
                ...
                <tr>
                  <th>Major</th>
                  <td>
                  <select type="text" name="aql_major" id="aql_major" class="form-control aql_select aql_major e_aqmj"required ></select>
                  <div id="aqlRequired4" style="display:none" ><p style="color:red;">This field is required! </p></div>
                  </td>
                  <td><input type="text " name="max_major" id="max_major" class="form-control max_major e_mxmj" />
                ...
                <tr>
                  <th>Minor</th>
                  <td><select type="text" name="aql_minor" id="aql_minor" class="form-control aql_select aql_minor e_aqmn"></select>
                  <div id="aqlRequired6" style="display:none" ><p style="color:red;">This field is required! </p></div>
                  </td>
                  <td><input type="text" name="max_minor" id="max_minor" class="form-control max_minor e_mxmn" />
        ...
        <div class="row">
          <div class="col-md-12">
              <table class="table-bordered table-condensed" width="100%">
                ...
                <tr>
                  <th>Normal</th>
                  <td><input type="text" name="aql_normal_letter" id="aql_normal_letter" class="form-control aql_normal_letter e_anl" >
                  <div id="aqlRequired8" style="display:none" ><p style="color:red;">This field is required! </p></div>
                  </td>
                  
                  <td><input type="text" name="aql_normal_sampsize" id="aql_normal_sampsize" class="form-control aql_normal_sampsize e_ans" />
                ...
                <tr>
                  <th>Special</th>
                  <td><input type="text" name="aql_special_letter" id="aql_special_letter" class="form-control aql_special_letter e_asl">
                  <div id="aqlRequired10" style="display:none" ><p style="color:red;">This field is required! </p></div>
                  </td>
                  
                  <td><input type="text" name="aql_special_sampsize" id="aql_special_sampsize" class="form-control aql_special_sampsize e_ass" />
