	...
	<div class="col-md-12">
		...
		<div class="col-md-4">
				<div class="form-group">
					...
					{!! Form::text('manday', $inspection_details->manday, ['class' => 'form-control  manday psi_required psi_draft_required','required'=>'','readOnly'=>'true']) !!}
				</div>
			</div>
</div>
				...
				<div class="row product-clone-edit">
					...
					<div class="clone-inputs-edit">					
						...
						<div class="col-md-1">
							<div class="form-group">
								<br/>
								<button type="button" class="btn btn-danger btn-rm-edit-product" data-id="{{$product->id}}"><i class="fa fa-times"></i></button>
							</div>
						</div>
		...
		<div class="row">
				<div class="col-md-12">
						<div class="form-group">
							...
							{{-- <label class="checkbox-inline">
								@if($inspection_details->project_type=="esprit")
								<input type="radio" name="project_type" value="esprit" id="esprit_project" class="psi_required" onclick="changeProjectType('esprit')" required checked> ESPRIT Project
								@else
									<input type="radio" name="project_type" value="null" id="esprit_project" class="" onclick="changeProjectType('esprit')" required> ESPRIT Project
								@endif
	...
	@if($inspection_details->project_type=="word_project")
		{{-- <div class="col-md-4 div_sub_service">
			<div class="form-group">
					...
					], $inspection_details->word_template, ['class' => 'form-control word_template', 'placeholder'=>'Select a Word Template', 'id'=>'word_template', 'required'=>'']) }}
				</div>
		</div> --}}
		{{-- <div class="col-md-12" id="blank_report">
			<div class="row">
					<div class="col-md-4">
							<div class="form-group">
								...
								<label class="checkbox-inline">
									...
									@if($inspection_details->report_type=="qr")
										<input type="radio" name="blank_report_type" value="qr" id="report_qr" class="blank_report_type"  required checked> QR
									@else
								...
								<label class="checkbox-inline">
									...
									@if($inspection_details->report_type=="dr")
										<input type="radio" name="blank_report_type" value="dr" id="report_dr" class="blank_report_type"  required checked> DR
									@else
								...
								<label class="checkbox-inline">
									...
									@if($inspection_details->report_type=="qr_dr")
										<input type="radio" name="blank_report_type" value="qr_dr" id="report_qr_dr" class="blank_report_type"  required checked> BOTH
									@else
			...
			{{-- <div class="col-md-4">
				<div class="form-group">
					...
					<select class="form-control" name="report_template" id="report_template" required>
						...
						@foreach($templates as $template)
							@if($inspection_details->word_template==$template->id)
								<option value="{{$template->id}}" selected>{{$template->name}}</option>
							@else
								<option value="{{$template->id}}">{{$template->name}}</option>
							@endif
