                    ...
                    <table style="width: 60%; margin: auto; border-collapse: collapse; border: 0; font-family: arial;">
                        ...
                        <tr>
                            <td colspan="2" style="padding: 20px; background-color: #ededed;">
                                ...
                                <p>Please see attached files for your inspection reference on {!!$inspection_date!!} and other info below. Kindly also see <b>app login details for geo tracking</b> from separate email.</p><br />
                                <p>Note :</p>
                                <p>{!! nl2br(e($memo)) !!} </p><br />
