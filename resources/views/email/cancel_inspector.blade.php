                        ...
                        <table style="width: 60%; margin: auto; border-collapse: collapse; border: 0; font-family: arial;">
                                ...
                                <tr>
                                    <td colspan="2" style="padding: 20px; background-color: #ededed;">       
                                        <p>Dear <b>{!!$old_insp_name!!}</b>,</p><br/>
                                        <p>This is to inform you that the inspection below has been cancelled. Please keep in touch for more updates. Thank you.</p><br/>
                                        <br>
                                        <p>Client Project Number : {!!$ref_num!!}</p>
                                        <p>Inspection Service : {!!$service!!}</p>
                                        <p>Inspection Date : {!!$inspection_date!!}</p>
                                        <p>Factory Name : {!!$factory_name!!}</p>
