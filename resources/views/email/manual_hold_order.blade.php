                        ...
                        <table style="width: 60%; margin: auto; border-collapse: collapse; border: 0; font-family: arial;">
                                ...
                                <tr>
                                    <td colspan="2" style="padding: 20px; background-color: #ededed;">       
                                        ...
                                        <p>Your booking has been received and is under review now. We are checking all details and availability of the requested inspection date. Once all is confirmed, we will come back to you.</p><br/>
                                        <br>
                                        <p>Thanks for your trust and good cooperation.</p>
                                       {{--  <p>{!! nl2br(e($email_message)) !!} </p><br/> --}}
                                        <br> <br>                                      
                                        <p>Your sincere, <br> TIC Team</p>
                                        <br><br>
                                    </td>
                                </tr>
                            </table>
