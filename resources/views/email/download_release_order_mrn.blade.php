    ...
    <div class="container">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading orange-background text-center" style="border-radius: 10px 10px 0px 0px;">
                    <h3>Download Blank Report for {!!$report_number!!}</h3>
                </div>
                    ...
                    <table style="width: 60%; margin: auto; border-collapse: collapse; border: 0; font-family: arial;">
                        ...
                        <tr>
                            <td colspan="2" style="padding: 20px; background-color: #ededed;">
                                ...
                                <br />
                                <p>
                                    Please see attached files for your inspection reference on <b>{!!$inspection_date!!}</b>. Kindly also see <b>app login details</b> from separate email to download the report from the app.
                                </p><br>
                                ...
                                <table style="width: 100%; border-collapse: collapse;">
                                    @foreach($psi_product_mrn as $key=>$psi_prod)
                                    <tr style="">
                                        <th style="border: 1px solid #848484; font-weight: bold; padding: 5px;" width="50%" align="left">Report Number {!! $loop->iteration !!} </th>
                                        <td style="border: 1px solid #848484; color:blue;">{!!$psi_prod->reference_number!!}</td>
                                    </tr>
                                    <tr style="">
