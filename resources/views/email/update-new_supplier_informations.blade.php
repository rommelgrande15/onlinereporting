                    ...
                    <table style="width: 60%; margin: auto; border-collapse: collapse; border: 0; font-family: arial;">
                        ...
                        <tr>
                             <td colspan="2" style="padding: 20px; background-color: #ededed;">
                                ...
                                <br/>
                                <p>
                                    Good Day! Your Supplier Account has been updated. Here is your new details and Supplier Client Contact details.
                                </p><br>
                                <p><a href='https://tic-service.company/'><b>Redirect me to Dashboard</b></a></p>

                                <p><b>Supplier Updated Details</b> </p>
                                <table style="width: 100%; border-collapse: collapse;">
                                    ...
                                    <tr style="">
                                        <th style="border: 1px solid #848484;  padding: 5px;" width="50%" align="left">Supplier Client Contact : </th>
                                        <td style="border: 1px solid #848484">{!!$supplier_contact_person!!}</td>
                                    </tr> 
                                    <tr style="">
                                        <th style="border: 1px solid #848484;  padding: 5px;" width="50%" align="left">Supplier Client Contact Number: </th>
                                        <td style="border: 1px solid #848484">{!!$supplier_contact_number!!}</td>
                                    </tr> 
                                    <tr style="">
                                        <th style="border: 1px solid #848484;  padding: 5px;" width="50%" align="left">Client Contact : </th>
                                        <td style="border: 1px solid #848484">{!!$contact_name!!}</td>
                                    </tr> 
                                    <tr style="">
                                        <th style="border: 1px solid #848484;  padding: 5px;" width="50%" align="left">Client Contact Number: </th>
                                        <td style="border: 1px solid #848484">{!!$contact_number_client!!}</td>
                                    </tr>  
                                </table>
                                <br>
