                                ...
                                <tr>
                                    <td colspan="2" style="padding: 20px; background-color: #ededed;">
                                        ...
                                        <table style="width: 100%; border-collapse: collapse;">
                                            ...
                                            <tr style="">
                                                <th style="border: 1px solid #848484; font-weight: bold; padding: 5px;" width="50%" align="left">Company Name</th>
                                                <td style="border: 1px solid #848484">{!!$company_name!!}</td>
                                            </tr> 
                                            <tr style="">
                                                <th style="border: 1px solid #848484; font-weight: bold; padding: 5px;" width="50%" align="left">Company Address</th>
                                                <td style="border: 1px solid #848484">{!!$company_address!!}</td>
                                            </tr> 
                                            <tr style="">
                                                <th style="border: 1px solid #848484; font-weight: bold; padding: 5px;" width="50%" align="left">Company Other Info</th>
