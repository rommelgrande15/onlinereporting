    ...
    <div class="row">
        <div class="col-md-12">
            <div class="col-md-12 padding-b-25">       
                <div class="">
                    @include('partials.client.copy-project._copyinspectionloading')
                </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        var saveCBPI = "{{route('client-copyloadinginspection')}}";
    ...
    {!! Html::script('/js/client/client-dropzone-cli-copy.js?v=2') !!}
