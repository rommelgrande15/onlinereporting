    ...
    <div class="row">
        <div class="col-md-12">
            <div class="col-md-12 padding-b-25">       
                <div class="">
                    @include('partials.client.edit-project._editinspectionloading')
                </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        var saveCBPI = "{{route('client-editloadinginspection')}}";
    ...
    {!! Html::script('/js/client/client-dropzone-cli-draft.js?v=2') !!}
