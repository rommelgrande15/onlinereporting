...
@section('title','Inspection Result Statistics')
@section('page-title','Inspection Result Statistics')
		...
		$.ajax({
			...
			success: function(response) {
				...
				if (datas) {
					...
					chart.options.title.text = 'Inspection Result Statistics - ' + response.month + ' 2021';
					chart.update();
