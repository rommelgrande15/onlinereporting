...
<script>
    ...
    $(document).ready(function () {
         ...
         var calendar = $('#calendar').fullCalendar({
            editable: true,
            events: SITEURL + "/inspection-calendar",
            ...
            events: SITEURL+ '/load-calendar-data',
            /* eventColor: '#3e9cbf', */
            ...
            eventMouseover: function (event, jsEvent, view) {  
                ...
                //tooltip.hide();        
                tooltip = '<div class="tooltiptopicevent" style="width:auto;height:auto;background:#f7f5f5;position:absolute;z-index:10001;padding:10px 10px 10px 10px ;  line-height: 200%;">' + 'Service : ' + event.service + '</br>' + 'Report # : '+ event.report_no + '</br>' + 'Inspection date : '+ event.ins_date +  '</div>';
