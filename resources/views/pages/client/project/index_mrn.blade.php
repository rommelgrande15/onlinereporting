...
@section('title','New Order Multiple Reports')
@section('page-title','New Order Multiple Reports')
@section('stylesheets')
...
<div class="row">
    <div class="col-md-12">
        <div class="col-md-12 padding-b-25">
            <div class="tic_form">
                @include('partials.client._newinspection_mrn')
            </div>
...
<script type="text/javascript">
    ...
    var savePSI = "{{route('client-saveinspection-mrn')}}";
...
{!! Html::script('/js/client/client-dropzone-psi-mrn.js?v=1') !!}
@endsection
