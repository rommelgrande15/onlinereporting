...
@section('title','New Order Development For Multiple Report Number')
@section('page-title','New Order Development For Multiple Report Number')
@section('stylesheets')
...
<div class="row">
    <div class="col-md-12">
        <div class="col-md-12 padding-b-25">
            <div class="tic_form">
                @include('partials.client._newinspection_dev_mr')
            </div>
...
<script type="text/javascript">
    ...
    var savePSI = "{{route('client-saveinspection-dev-mrn')}}";
...
{!! Html::script('/js/client/project_dev_mr.js?v=1') !!}
{!! Html::script('/js/client/client-dropzone-cli.js?v=4') !!}
{!! Html::script('/js/client/client-dropzone-psi-dev-mrn.js?v=1') !!}
@endsection
