...
@section('title','New Order Dev2')
@section('page-title','New Order Dev2')
@section('stylesheets')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="col-md-12 padding-b-25">       
                <div class="tic_form">
                    @include('partials.client.project._newinspection_dev')
                </div>
...
@section('scripts')
	...
	{!! Html::script('/js/client/project_dev.js') !!}
    {!! Html::script('/js/client/client-dropzone-cli.js') !!}
    {!! Html::script('/js/client/client-dropzone-psi.js') !!}
@endsection
