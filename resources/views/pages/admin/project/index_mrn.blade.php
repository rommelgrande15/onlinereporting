@extends('layouts.new')
@section('title','New Project For Multiple Report Number')
@section('page-title','New Project For Multiple Report Number')
@section('stylesheets')
...
<div class="row">
    <div class="col-md-12">
        <div class="col-md-12 padding-b-25">
            <div class="tic_form">
                @include('partials._newinspectionMRN')
            </div>
            ...
            @include('partials.product-category._inputsubcategory2') --}}
        </div>
    </div>
...
<script type="text/javascript">
    ...
    var savePSI = "{{route('saveinspection-dev-mr')}}";
...
{!! Html::script('/js/admin/project-dev-mr.js') !!}
{!! Html::script('/js/admin/dropzone-send.js?v=1') !!}
{!! Html::script('/js/admin/dropzone-psi-mrn.js?v=1') !!}
{!! Html::script('/js/admin/dropzone-site-visit.js?v=1') !!}

<script>
    $("#factory").select2();
    //$("#inspector").select2();;

    //$("#loading_inspector").select2("destroy");
    //$("#loading_inspector").select2();

    //$("#loading_factory").select2("destroy");
