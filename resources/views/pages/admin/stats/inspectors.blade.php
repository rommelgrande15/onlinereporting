@extends('layouts.new')
@section('title','Inspectors Statistics')
@section('page-title','Inspectors Statistics')
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (datas) {
                    ...
                    chart.options.title.text = total_manday+' Inspector/s Statistics - ' + response.month + ' 2021';
                    chart.update();
