@extends('layouts.new')
@section('title','Booking Teams Statistics')
@section('page-title','Booking Teams Statistics')
            ...
            success: function(response) {
                ...
                if (datas) {
                    $.each(datas, function(key, value) {
                        ...
                        total_manday = total_manday + value.manday;
                        
                        chart.data.labels = bg_color;
                        chart.data.datasets[0].data = manday;
                        chart.data.datasets[0].backgroundColor = bg_color;
                        chart.data.datasets[0].label = ranges;
                        console.log(datas);
                        /*$.each(datas.data, function(key, value2) {
                            console.log(index);
                            console.log(value2.name);
                            console.log(value2.count);
                        });*/
                        
                        //chart.data.datasets[0].data = passed;
                    ...
                    chart.options.title.text = total_manday+' Booking Team Statistics - ' + response.month + ' 2021';
                    chart.update();
