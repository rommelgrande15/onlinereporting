@extends('layouts.new')
@section('title','Suppliers Statistics')
@section('page-title','Suppliers Statistics')
    ...
    function search(chart, url, data) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                chart.options.title.text = 'Suppliers Statistics ' + response.month + ' 2021';
                chart.update();
            }
        })
    }
