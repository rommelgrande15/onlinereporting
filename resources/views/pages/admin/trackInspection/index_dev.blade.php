...
@section('page-title','Track Inspection')
	...
	<div class="row">
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading orange-background"><h3>Inspection Tracking Dev</h3></div>
					...
					<div class="row">
						<div class="col-md-4">
							...
							<div class="row">
								<br/>
								<div class="col-md-12">
									<h4 class="text-center">Inspection Details</h5>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="table-responsive">
										<table id="other_details_table" class="table table-condensed small dataTable no-footer">
											<thead>
												<tr>
													<th>Label</th>				
													<th>Details</th>				
											...
											<tbody>
												<tr>
													...
													<td>@if($inspection_details->service) {!!$services[$inspection_details->service]!!} @endif</td>
												</tr>
												<tr>
													<td>Report Number</td>
													<td>{!!$inspection_details->reference_number!!}</td>
												</tr>
												<tr>
													<td>Client Project Number</td>
													<td>{!!$inspection_details->reference_number!!}</td>
												</tr>
												<tr>
													<td>Inspection Date</td>
													<td>@if($inspection_details->inspection_date==$inspection_details->inspection_date_to || $inspection_details->inspection_date_to==''){!!$inspection_details->inspection_date!!} @else {!!$inspection_details->inspection_date!!} to {!!$inspection_details->inspection_date_to!!}@endif</td>
												</tr>
												<tr>
												...
												<tr>
													<td>Client</td>
													<td>{!!$inspection_details->client_name!!}</td>
												</tr>
												<tr>
													<td>Factory</td>
													<td>{!!$inspection_details->factory_name!!}</td>
												</tr>
											</tbody>
										</table>
									</div>
