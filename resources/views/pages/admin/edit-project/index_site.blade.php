    ...
    <div class="row">
        <div class="col-md-12">
            <div class="col-md-12 padding-b-25">       
                <div class="tic_form">
                    @include('partials._editinspectionsite')
                </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        var saveEditedSite = "{{route('edited-draft-inspection-site')}}";
        var routeupdatePsiDraft = "{{route('editpsidraft')}}";
        var routeupdateSiteDraft = "{{route('editsitedraft')}}";
    ...
    {!! Html::script('/js/admin/dropzone-site-visit-draft.js?v=2') !!}
