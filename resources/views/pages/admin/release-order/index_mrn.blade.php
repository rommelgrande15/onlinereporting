@extends('layouts.new')
@section('title','Release Client Order - Multiple Report Number')
@section('page-title','Release Client Order - Multiple Report Number')
@section('stylesheets')
...
<div class="row">
    <div class="col-md-12">
        <div class="col-md-12 padding-b-25">
            <div class="tic_form">
                @include('partials.admin.release-order._editorderMrn')
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    var releaseorder = "{{route('releaseorder-mrn')}}";
    var holdorder = "{{route('holdorder-mrn')}}";
...
{!! Html::script('/js/admin/dropzone-psi-release-order-mrn.js?v=2') !!}
<script>
