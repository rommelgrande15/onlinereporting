...
<div class="row">
    <div class="col-md-12">
        <div class="col-md-12 padding-b-25">
            <div class="tic_form">
                @include('partials.admin.release-order._editordercbpi')
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    var releaseorder = "{{route('releaseordercbpi')}}";
    var holdorder = "{{route('holdordercbpi')}}";
...
{!! Html::script('/js/admin/dropzone-cbpi-release-order.js?v=2') !!}
