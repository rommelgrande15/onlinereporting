...
<div class="row">
    <div class="col-md-12">
        <div class="col-md-12 padding-b-25">
            <div class="tic_form">
                @include('partials.admin.copy-project._copyinspection')
            </div>
...
<script type="text/javascript">
    ...
    var auth_id = "{{Auth::id()}}";
    var savePSI = "{{route('save-copy-inspection')}}";
...
{!! Html::script('/js/admin/dropzone-psi-copy.js?v=1') !!}
{{-- {!! Html::script('/js/admin/project-edit-psi.js?v=1') !!} --}}
<script>
    $("#factory").select2();
    //$("#inspector").select2();
</script>
