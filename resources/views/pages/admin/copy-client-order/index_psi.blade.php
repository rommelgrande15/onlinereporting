@extends('layouts.new')
@section('title','Copy Client Order')
@section('page-title','Copy Client Order')
@section('stylesheets')
...
<div class="row">
    <div class="col-md-12">
        <div class="col-md-12 padding-b-25">
            <div class="tic_form">
                @include('partials.admin.copy-client-order._copyorder')
            </div>
        </div>
    </div>
</div>
...
@include('partials.admin.copy-client-order._newsupplier')
@include('partials.admin.copy-client-order._newfactory')
@include('partials.admin.copy-client-order._newproduct')
@include('partials.admin.copy-client-order._editproduct')
@endsection
