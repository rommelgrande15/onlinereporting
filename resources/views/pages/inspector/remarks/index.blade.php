...
@section('page-title','Remarks & Additional Information Form')
@section('stylesheets')
<style>
    :root {
        /* larger checkbox */
        ...
        <div class="col-md-12 padding-b-25">	
            <div class="col-md-12">
                <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th class="col-md-12">
                                    ...
                                    <center><textarea name="" id="" cols="180" rows="7"></textarea></center>
                                </th>
                            </tr>
                            <tr>
                                <th class="col-md-12">
                                    <h4 style="margin-left: 20px;">Photos</h4>
                    ...
                    <div class="col-md-12">
                        <button type="button" class="btn btn-primary" style="position: absolute; right: 0; margin-right: 25px;">Add New Remarks</button>
                    </div>
            </div>
        </div>
    </div>
