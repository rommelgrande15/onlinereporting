...
@include('pages.supplier.dashboard._viewprojectdetails')
@include('pages.supplier.dashboard._cancelinspection')
@include('pages.supplier.dashboard._deleteinspection')
<div class="se-pre-con"></div>
<div class="send-loading"></div>
@endsection

@section('scripts')
{!! Html::script('/js/client/panel-supplier.js?v=4') !!}
<script>
    ...
    $(document).ready(function() {
        $('#inspections_tbl').DataTable({
            ...
            "serverSide": true,
            "ajax": {
                "url": "{{ route('panel-supplier-get-mrn') }}",
                "dataType": "json",
                "type": "POST",
                "data": {
                    _token: "{{csrf_token()}}",
