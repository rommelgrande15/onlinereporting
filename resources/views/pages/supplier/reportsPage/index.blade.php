						...
						<td align="center">
							<div class='dropdown'>
                				...
                				<ul class='dropdown-menu'>
                                    <li><a class="btn btn-xs btn_view" data-id="{{$inspection->id}}" data-ref_no="{{$inspection->reference_number}}" data-toggle="tooltip" title="Uploaded Report">Download Report</a></li>
									...
									@if($inspection->inspection_status == 'Shipment Accepted')
                				    	{{-- <li><a href="#" class="btn btn-xs btn_view" id="btn_view" data-id="{{$inspection->id}}" data-ref_no="{{$inspection->reference_number}}" data-toggle="tooltip" title="Uploaded Report">Download Report</a></li> --}}
...
@include('partials.client.supplier.reportsPage._view_report')
@include('partials.client.supplier.reportsPage._viewprojectdetails')
@include('partials.client.supplier.reportsPage._viewprojectdetails_cbpi')
@include('partials.client.supplier.reportsPage.confirm_remove_file')
