...
@section('title','New Order Supplier Multiple Report Number')
@section('page-title','New Order Supplier Multiple Report Number')
@section('stylesheets')
...
<div class="row">
    <div class="col-md-12">
        <div class="col-md-12 padding-b-25">
            <div class="tic_form">
                @include('partials.client.supplier._newinspectionMrn')
            </div>
...
<script type="text/javascript">
    ...
    var savePSI = "{{route('supplier-client-saveinspection-mrn')}}";
...
{!! Html::script('/js/client/project_mrn.js?v=1') !!}
{!! Html::script('/js/client/supplier-dropzone-psi-mrn.js?v=1') !!}
