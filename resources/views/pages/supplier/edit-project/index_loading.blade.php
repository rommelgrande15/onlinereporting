    ...
    <div class="row">
        <div class="col-md-12">
            <div class="col-md-12 padding-b-25">       
                <div class="">
                    @include('partials.client.supplier-edit-project._editinspectionloadingsupplier')
                </div>
...
@section('scripts')
    <script type="text/javascript">
        ...
        var saveCBPI = "{{route('supplier-editloadinginspection')}}";
    ...
    {!! Html::script('/js/client/supplier-dropzone-cli-draft.js') !!}
