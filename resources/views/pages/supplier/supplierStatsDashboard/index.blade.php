...
<div class="row">
    <div class="col-md-12">
        <form class="form-inline" action="" method="post">
            ...
            <div class="btn-group">
                {{--<button class="btn btn-primary" id="search-date-button" type="submit"><i class="fa fa-search"></i> Search</button>--}}
                <button class="btn btn-primary" id="export_btn" type="button"><i class="fa fa-download"></i> Export</button>
                {{--<button class="btn btn-danger" id="btn_clear" type="button"><i class="fa fa-trash"></i> Clear</button>--}}
            </div>
        </form>
        <br>
    </div>
    <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="info-box">
            <span class="info-box-icon bg-aqua"><span class="iconify" data-icon="wpf:inspection" data-inline="false"></span></span>

            <div class="info-box-content">
                <span class="info-box-text">TOTAL INSPECTION <span class="info-box-number" id="inspection_count">{{ $inspection_count }}</span></span>

                {{-- <!--<span class="info-box-text">TOTAL REPORTS UPLOADED <span class="info-box-number" id="inspection_count">{{ $inspection_uploaded }}</span></span>--> --}}
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="info-box">
            <span class="info-box-icon bg-green"><span class="iconify" data-icon="wpf:inspection" data-inline="false"></span></span>

            <div class="info-box-content">
                <span class="info-box-text">Total Shipment Accepted</span>
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="info-box">
            <span class="info-box-icon bg-red"><span class="iconify" data-icon="wpf:inspection" data-inline="false"></span></span>

            <div class="info-box-content">
                <span class="info-box-text">Total Shipment Rejected</span>
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text">TOTAL REPORTS UPLOADED <span class="info-box-number" id="inspection_uploaded">{{ $inspection_uploaded }}</span></span>
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="info-box">
            <span class="info-box-icon bg-yellow"><span class="iconify" data-icon="wpf:inspection" data-inline="false"></span></span>
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Total Cancelled/Hold</span>
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Total Report Pending</span>
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text">Total Report Passed</span>
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="info-box">
            <span class="info-box-icon bg-red"><span class="iconify" data-icon="wpf:inspection" data-inline="true"></span></span>

            <div class="info-box-content">
                <span class="info-box-text">Total Report Failed</span>
...
<div class="box box-info">
    <div class="box-header with-border">
        ...
        <div class="box-tools pull-right">
            ...
            <a href="panel-supplier/{{ Auth::id() }}" class="btn btn-sm btn-default btn-flat">View All Orders</a>
            <a href="project-supplier" class="btn btn-sm btn-info btn-flat">Place New Order</a>
            <!-- /.box-footer -->
    ...
    <input type="text" class="hidden supplier_name_sup" id="supplier_name_sup" value="{{ $supplierData->id }}">
</div>
<!-- /.box -->
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#btn_clear").click(function(event) {
            ...
            $("#select_supplier").prop('selectedIndex', 0).change();
            $('#daterange-btn').datepicker('setDate', null);
        ...
        $('body').on('click', '#export_btn', function() {
            ...
            var supplier = $('#supplier_name_sup').val();
            $.ajax({
        ...
        $('body')
            ...
            .on('click', '#search-date-button,.applyBtn', function(event) {
                event.preventDefault();
                search();
    ...
    function search() {
        ...
        supplier = $('#supplier_name_sup').val();
        ...
        $.ajax({
            //url: '/project-details-cbpi/' + dis_id,
            url: "{{ route('supplier.stats.dashboard.search') }}",
            type: 'POST',
            data: {
