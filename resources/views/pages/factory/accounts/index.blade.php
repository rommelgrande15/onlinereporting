...
@section('title','Factory Accounts')
@section('page-title','Factory Accounts')
@section('stylesheets')
...
@section('content')
    ...
    {{-- @include('partials.factory.accounts._newaccount')
    @include('partials.factory.accounts._updateaccount')
    @include('partials.factory.accounts._deleteaccount')
    @include('partials.factory.accounts._privilege') --}}

    <div class="send-loading"></div>
@endsection

@section('scripts')
	{!! Html::script('/js/factory/factory-accounts.js?v=1') !!}
@endsection
