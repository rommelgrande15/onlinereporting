...
class AdminAccountControllerDev extends Controller
{
    ...
    public function getDashboardPanelDev($id){
		...
		return view('pages.admin.dashboard.index_dev',compact('inspections','services','role','user_info','user_manager','product','psiproduct','services_new','inspector_list','new_client_count','new_post_client'));    	
    }
    ...
    public function getSuppliersListAdmin(){
        ...
        $suppliers = Supplier::where('client_code',null)->where('supplier_status',0)->get();
    ...
    public function getInspectionProjectForm(){
        ...
        //suppliers data
        $suppliers = Supplier::where('supplier_status','!=',2)->where('added_by','admin')->orderBy('supplier_name', 'asc')->get();
		...
		$new_client_count = DB::table('clients')
			...
			->count();
        $new_post_client = Inspection::where('inspection_status','Client Pending')->count();
        return view('pages.admin.project-dev.index',compact('clients','role','user_info','inspectors','factories','countries','products','templates','templates_chinese','inspectors_new','files_blank_report','inspectors_two','currency','new_client_count','new_post_client','suppliers'));
    }
            ...
            if ($inspection->save()) {
                ...
                if($get_attachment){
                    ...
                    foreach ($get_attachment as $att) {                   
                        ...
                        $new_att->project_number = $request['site_reference_number'];
    ...
    public function deleteInspection($id){
        ...
        $report = Report::where('inspection_id',$id); 
        $attachment = Attachment::where('inspection_id',$id); 
