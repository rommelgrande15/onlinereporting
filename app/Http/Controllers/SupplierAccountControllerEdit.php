...
class SupplierAccountControllerEdit extends Controller
{
    public function getPSIProjectFormEdit($id){
      ...
      //  return $id;
        ...
        return view('pages.supplier.edit-project.index',compact('role','user_info','products','client_id','client_code','client_contact','client_aql_detail',
        ...
        'aql_options','services','sub_acc','privelege', 'clientName','supplierInfo','supplierData'));
    }
