...
class AdminAccountController extends Controller
{
    ...
    public function getDashboardPanel($id){
        ...
        $new_client_count = Client::where('client_code','000')->count();
			...
			return view('pages.admin.dashboard.index_new',compact('inspections','services','role','user_info','user_manager','product','psiproduct','services_new','inspector_list','new_client_count'));
    ...
    public function getClientBookingList(){
        ...
        $psiproduct = PSIProduct::all();
        $new_client_count = Client::where('client_code','000')->count();
		return view('pages.admin.client-booking.index',compact('inspections','services','role','user_info','user_manager','product','psiproduct','services_new','inspector_list','new_client_count'));    	
    }
    ...
    public function getInspectionProjectForm(){
        ...
        $new_client_count = Client::where('client_code','000')->count();
        return view('pages.admin.project.index',compact('clients','role','user_info','inspectors','factories','countries','products','templates','templates_chinese','inspectors_new','files_blank_report','inspectors_two','currency','new_client_count'));
    }
    ...
    public function getTemplateForm() {
        ...
        $new_client_count = Client::where('client_code','000')->count();
        return view('pages.admin.templates.index', compact('clients','role','user_info','inspectors','factories','countries','products','templates','new_client_count'));
    }
