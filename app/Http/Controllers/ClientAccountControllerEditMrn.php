...
class ClientAccountControllerEditMrn extends Controller
{
    ...
    public function getDashboardPanelClient($id){
       ...
       $new_post_client = Inspection::where('inspection_type',null)
		...
		return view('pages.client.dashboard.index',compact('inspections','services','role','user_info','user_manager','product','psiproduct','services_new','inspector_list','services_client','user','new_post_client'));    	
    }
    ...
    public function getProductDashboard(){
       ...
       $new_post_client = Inspection::where('inspection_type',null)
                                    ...
                                    ->where('client_id',$ccode->client_code)
                                    ->count();
		return view('pages.client.product.index',compact('role','user_info','client_code','products','user','new_post_client'));    	
    }
    ...
    public function getInspectionProjectForm(){
       ...
       $new_post_client = Inspection::where('inspection_type',null)
        ...
        return view('pages.client.project.index',compact('role','user_info','inspectors','factories','countries','products','inspectors_new','inspectors_two','client_id','client_code','ref_num','client_contact','client_aql_detail','client_aql_minors','client_aql_majors','normal','special','$aql_major','user','suppliers','new_post_client'));
    }
    ...
    public function getInspectionProjectFormEdit($id){
        ...
        $inspection_multiple = $inspection->mrn_no;
        $inspection_mrn = Inspection::where('mrn_no',$inspection_multiple)->get();
        //factory
       ...
       // $psiproducts = PSIProduct::where('inspection_id',$id)->get();
        //$psiproducts = PSIProduct::where('mrn_no',$inspection->mrn_no)->get();
        
        $units=['piece'=>'Piece/s','roll'=>'Roll/s','set'=>'Set/s','pair'=>'Pair/s','box'=>'Box/es'];
        $attach_count=0;
        $attach_arr=array();
        if($inspection->mrn_no == null){
            $psiproducts = PSIProduct::where('inspection_id',$id)->get();
            $countpsi = $psiproducts->count();
        }else{
            //$psiproducts = PSIProduct::where('mrn_no',$inspection->mrn_no)->first();
            $psiproducts = DB::table('p_s_i_products')
                    ->join('inspections','inspections.mrn_no', '=', 'p_s_i_products.mrn_no')
                    ->select('inspections.reference_number','p_s_i_products.*')
                    ->where('inspection_id',$inspection->id)
                    ->where(['p_s_i_products.mrn_no' => $inspection->mrn_no])
       ...
       $new_post_client = Inspection::where('inspection_type',null)
        ...
        return view('pages.client.edit-project.index',compact('role','user_info','products','client_id','client_code','client_contact','client_aql_detail',
        ...
        'special','aql_major','user','supplier_list','supplier_con_list','supplier_info','supplier_con_info','psiproducts','countpsi','units','attach_arr','p_category','aql_options','services','sub_acc','privelege','new_post_client','inspection_mrn'));
    }
    ...
    public function getInspectionLoadingProjectFormEdit($id){
       ...
       $new_post_client = Inspection::where('inspection_type',null)
        ...
        return view('pages.client.edit-project.index_loading',compact('role','user_info','client_id','client_code','client_contact','inspection','get_factory','get_fc','factory_con_list','factory_list','get_cc','user','supplier_list','supplier_con_list','supplier_info','supplier_con_info','sub_acc','privelege','new_post_client'));
    }
    ...
    public function getInspectionLoadingProjectFormCopy($id){
       ...
       $new_post_client = Inspection::where('inspection_type',null)
        ...
        return view('pages.client.copy-project.index_loading',compact('role','user_info','client_id','client_code','client_contact','inspection','get_factory','get_fc','factory_con_list','factory_list','get_cc','user','supplier_list','supplier_con_list','supplier_info','supplier_con_info','sub_acc','privelege','reference_num','new_post_client'));
    }
    ...
    public function getFactoryListClient(){
       ...
       $new_post_client = Inspection::where('inspection_type',null)
        ...
        return view('pages.client.factory.index',compact('role','factories','user_info','countries','client_code','req','user','new_post_client'));
    }
    public function getSuppliersListClient(){
       ...
       $new_post_client = Inspection::where('inspection_type',null)
                                    ...
                                    ->where('client_id',$ccode->client_code)
                                    ->count();
        return view('pages.client.supplier.index',compact('role','suppliers','user_info','countries','client_code','user','new_post_client'));
    }
    ...
    public function getFactoryBySupplier($id){
       ...
       $new_post_client = Inspection::where('inspection_type',null)
                                    ...
                                    ->where('client_id',$ccode->client_code)
                                    ->count();
        return view('pages.client.factory.index',compact('role','factories','user_info','client_code','req','supplier_id','user','suppliers','new_post_client'));
    }
    ...
    public function getCreateAccountForm(){
       ...
       $new_post_client = Inspection::where('inspection_type',null)
                                    ...
                                    ->where('client_id',$ccode->client_code)
                                    ->count();
        return view('pages.client.createAccount.index',compact('countries','new_post_client'));
    }
    ...
    public function getCreateAccountFormNew(){
       ...
       $new_post_client = Inspection::where('inspection_type',null)
                                    ...
                                    ->where('client_id',$ccode->client_code)
                                    ->count();
        return view('pages.client.createAccount.new_register',compact('countries','new_post_client'));
    }
 ...
 if ($product->save()) {
    ...
    public function getAccountDashboard(){
       ...
       $new_post_client = Inspection::where('inspection_type',null)
                                    ...
                                    ->where('client_id',$ccode->client_code)
                                    ->count();
		return view('pages.client.accountsettings.index',compact('role','user_info','client_code','client','client_contact','user','client_aql_detail','client_aql_minors','client_aql_majors','normal','special','$aql_major','new_post_client'));    	
    }
    ...
    private function getReferenceNumber($id, $inspect_date){
    ...
    //ADDED BY ROMMEL - FOR MULTIPLE EDIT
    public function getInspectionProjectFormEditMrn($id){
        $sub_acc="no";
        $privelege="";
        $client_id="";
        $g = User::select('group_id')->where('id',Auth::id())->first();
        ...
        $inspection_mrn = DB::table('inspections')
                ...
                ->where('inspections.mrn_no',$inspection->mrn_no)
    ...
    $ccode = DB::table('clients')->where('user_id',Auth::id())->first();
       $new_post_client = Inspection::where('inspection_type',null)
        ...
        return view('pages.client.multiple-edit-project.index',compact('role','user_info','products','client_id','client_code','client_contact','client_aql_detail',
        'client_aql_minors','client_aql_majors','inspection','get_factory','get_fc','factory_con_list','factory_list','get_cc','client_aql_majors','normal',
        'special','aql_major','user','supplier_list','supplier_con_list','supplier_info','supplier_con_info','psiproducts','countpsi','units','attach_arr','p_category','aql_options','services','sub_acc','privelege','new_post_client','inspection_mrn'
        ,'reports'));
    }
