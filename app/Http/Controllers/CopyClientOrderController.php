...
class CopyClientOrderController extends Controller
{
    ...
    public function copyClientOrder(Request $request){
        ...
        try {
            ...
            $inspection->client_book = null;
            $inspection->client_book_id = null;
    ...
    //client copy order
    public function copyClientOrderLoading(Request $request){
        DB::beginTransaction();
        try {
            //$inspection = new Inspection();
