...
class ServerSideControllerDev extends Controller
{
    ...
    public function getClientBookingList(){  
		...
		return view('pages.admin.client-booking.index_new',compact('role','user_info','new_client_count','new_post_client'));    	
    }
    ...
    public function getClientInspections(Request $request){
        ...
        if($inspection){
            foreach ($inspection as $ins){
                ...
                $nestedData['client'] = $ins->client;
                $nestedData['created_by'] = $ins->created_by;
