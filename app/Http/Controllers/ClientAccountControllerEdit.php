...
class ClientAccountControllerEdit extends Controller
{
    ...
    public function getInspectionProjectFormEdit($id){
       ...
       $new_post_client = Inspection::where('inspection_type',null)
        ...
        'special','aql_major','user','supplier_list','supplier_con_list','supplier_info','supplier_con_info','psiproducts','countpsi','units','attach_arr','p_category','aql_options','services','sub_acc','privelege','new_post_client'));
    }
